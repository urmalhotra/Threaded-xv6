   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 0d 05 00 00       	call   52a <getpid>
  1d:	a3 c8 0d 00 00       	mov    %eax,0xdc8

   int i, thread_pid, join_pid;
   for(i = 0; i < 10; i++) {
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      global = 1;
  28:	c7 05 c4 0d 00 00 01 	movl   $0x1,0xdc4
  2f:	00 00 00 
  ...
  4c:	e8 2f 04 00 00       	call   480 <thread_join>
      assert(join_pid == thread_pid);
  51:	39 c3                	cmp    %eax,%ebx
  53:	0f 85 84 00 00 00    	jne    dd <main+0xdd>
      assert(global == 5);
  59:	a1 c4 0d 00 00       	mov    0xdc4,%eax
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 c1 04 00 00       	call   532 <sbrk>
  ...
  84:	50                   	push   %eax
  85:	50                   	push   %eax
  86:	68 a9 09 00 00       	push   $0x9a9
  8b:	6a 01                	push   $0x1
  8d:	e8 7e 05 00 00       	call   610 <printf>
   exit();
  92:	e8 13 04 00 00       	call   4aa <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  99:	68 38 09 00 00       	push   $0x938
  9e:	68 42 09 00 00       	push   $0x942
  a3:	6a 01                	push   $0x1
  a5:	e8 66 05 00 00       	call   610 <printf>
  aa:	83 c4 0c             	add    $0xc,%esp
  ad:	68 77 09 00 00       	push   $0x977
      assert(join_pid == thread_pid);
  b2:	68 56 09 00 00       	push   $0x956
  b7:	6a 01                	push   $0x1
  b9:	e8 52 05 00 00       	call   610 <printf>
  be:	5a                   	pop    %edx
  bf:	59                   	pop    %ecx
  c0:	68 6a 09 00 00       	push   $0x96a
  c5:	6a 01                	push   $0x1
  c7:	e8 44 05 00 00       	call   610 <printf>
  cc:	5b                   	pop    %ebx
  cd:	ff 35 c8 0d 00 00    	push   0xdc8
  d3:	e8 02 04 00 00       	call   4da <kill>
  d8:	e8 cd 03 00 00       	call   4aa <exit>
  dd:	6a 22                	push   $0x22
  df:	68 38 09 00 00       	push   $0x938
  e4:	68 42 09 00 00       	push   $0x942
  e9:	6a 01                	push   $0x1
  eb:	e8 20 05 00 00       	call   610 <printf>
  f0:	83 c4 0c             	add    $0xc,%esp
  f3:	68 86 09 00 00       	push   $0x986
  f8:	eb b8                	jmp    b2 <main+0xb2>
      assert(global == 5);
  fa:	6a 23                	push   $0x23
  fc:	68 38 09 00 00       	push   $0x938
 101:	68 42 09 00 00       	push   $0x942
 106:	6a 01                	push   $0x1
 108:	e8 03 05 00 00       	call   610 <printf>
 10d:	83 c4 0c             	add    $0xc,%esp
 110:	68 9d 09 00 00       	push   $0x99d
 115:	eb 9b                	jmp    b2 <main+0xb2>
      assert((uint)sbrk(0) < (150 * 4096) && "shouldn't even come close");
 117:	6a 25                	push   $0x25
 119:	68 38 09 00 00       	push   $0x938
 11e:	68 42 09 00 00       	push   $0x942
 123:	6a 01                	push   $0x1
 125:	e8 e6 04 00 00       	call   610 <printf>
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 c4 0d 00 00       	mov    0xdc4,%eax
 14b:	83 f8 01             	cmp    $0x1,%eax
 14e:	74 46                	je     196 <worker+0x56>
 150:	6a 2e                	push   $0x2e
 152:	68 38 09 00 00       	push   $0x938
 157:	68 42 09 00 00       	push   $0x942
 15c:	6a 01                	push   $0x1
 15e:	e8 ad 04 00 00       	call   610 <printf>
 163:	83 c4 0c             	add    $0xc,%esp
 166:	68 4a 09 00 00       	push   $0x94a
 16b:	68 56 09 00 00       	push   $0x956
 170:	6a 01                	push   $0x1
 172:	e8 99 04 00 00       	call   610 <printf>
 177:	58                   	pop    %eax
 178:	5a                   	pop    %edx
 179:	68 6a 09 00 00       	push   $0x96a
 17e:	6a 01                	push   $0x1
 180:	e8 8b 04 00 00       	call   610 <printf>
 185:	59                   	pop    %ecx
 186:	ff 35 c8 0d 00 00    	push   0xdc8
 18c:	e8 49 03 00 00       	call   4da <kill>
 191:	e8 14 03 00 00       	call   4aa <exit>
   global += 4;
 196:	a1 c4 0d 00 00       	mov    0xdc4,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 c4 0d 00 00       	mov    %eax,0xdc4
   exit();
 1a3:	e8 02 03 00 00       	call   4aa <exit>
 ...
 2d9:	31 db                	xor    %ebx,%ebx
{
 ...
 2e5:	57                   	push   %edi
 2e6:	6a 00                	push   $0x0
 2e8:	e8 d5 01 00 00       	call   4c2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 34d:	e8 98 01 00 00       	call   4ea <open>
  if(fd < 0)
 ...
 361:	50                   	push   %eax
 362:	e8 9b 01 00 00       	call   502 <fstat>
  close(fd);
 367:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 36a:	89 c6                	mov    %eax,%esi
  close(fd);
 36c:	e8 61 01 00 00       	call   4d2 <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 44b:	e8 f0 03 00 00       	call   840 <malloc>
  original_stack = *(uint*)(stack);
  if((uint)stack % 4096 != 0)
 450:	83 c4 10             	add    $0x10,%esp
  original_stack = *(uint*)(stack);
 453:	8b 10                	mov    (%eax),%edx
 455:	89 15 cc 0d 00 00    	mov    %edx,0xdcc
  if((uint)stack % 4096 != 0)
 45b:	89 c2                	mov    %eax,%edx
 45d:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
 463:	74 07                	je     46c <thread_create+0x2c>
    stack = stack + (4096 - (uint)stack % 4096);
 465:	29 d0                	sub    %edx,%eax
 467:	05 00 10 00 00       	add    $0x1000,%eax
  return clone(start_routine, arg1, arg2, stack);
 46c:	50                   	push   %eax
 46d:	ff 75 10             	push   0x10(%ebp)
 470:	ff 75 0c             	push   0xc(%ebp)
 473:	ff 75 08             	push   0x8(%ebp)
 476:	e8 d7 00 00 00       	call   552 <clone>
}
 47b:	c9                   	leave  
 47c:	c3                   	ret    
 ...
 56c:	89 d1                	mov    %edx,%ecx
{
 ...
 599:	0f b6 92 54 0a 00 00 	movzbl 0xa54(%edx),%edx
 ...
 619:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 689:	ff 24 85 fc 09 00 00 	jmp    *0x9fc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 797:	90                   	nop
          s = "(null)";
 798:	ba f4 09 00 00       	mov    $0x9f4,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7b1:	a1 d0 0d 00 00       	mov    0xdd0,%eax
{
 ...
 7f1:	5b                   	pop    %ebx
  freep = p;
 7f2:	89 15 d0 0d 00 00    	mov    %edx,0xdd0
}
 7f8:	5e                   	pop    %esi
 7f9:	5f                   	pop    %edi
 7fa:	5d                   	pop    %ebp
 ...
 829:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 82c:	89 15 d0 0d 00 00    	mov    %edx,0xdd0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 849:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 84c:	8b 3d d0 0d 00 00    	mov    0xdd0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 88f:	73 4f                	jae    8e0 <malloc+0xa0>
    ...
    if(p == freep)
 891:	8b 3d d0 0d 00 00    	mov    0xdd0,%edi
 ...
 8ba:	e8 f1 fe ff ff       	call   7b0 <free>
  return freep;
 8bf:	8b 15 d0 0d 00 00    	mov    0xdd0,%edx
 ...
 8ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8ef:	89 15 d0 0d 00 00    	mov    %edx,0xdd0
}
 ...
 8ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 900:	c7 05 d0 0d 00 00 d4 	movl   $0xdd4,0xdd0
 907:	0d 00 00 
    base.s.size = 0;
 90a:	bf d4 0d 00 00       	mov    $0xdd4,%edi
    base.s.ptr = freep = prevp = &base;
 90f:	c7 05 d4 0d 00 00 d4 	movl   $0xdd4,0xdd4
 916:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 919:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 91b:	c7 05 d8 0d 00 00 00 	movl   $0x0,0xdd8
 922:	00 00 00 
    if(p->s.size >= nunits){
