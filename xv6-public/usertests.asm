...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 7f 39 00 00       	call   39aa <open>
    ...
    exit();
      40:	e8 25 39 00 00       	call   396a <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 54 39 00 00       	call   39aa <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 34 39 00 00       	call   3992 <close>
  ...
  exit();
     10d:	e8 58 38 00 00       	call   396a <exit>
...
00000120 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
     ...
     13d:	e8 90 38 00 00       	call   39d2 <mkdir>
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 84 38 00 00       	call   39da <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 4c 38 00 00       	call   39ba <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 58 38 00 00       	call   39da <chdir>
  ...
  printf(stdout, "iput test ok\n");
    ...
    exit();
     1b3:	e8 b2 37 00 00       	call   396a <exit>
    ...
    exit();
     1ca:	e8 9b 37 00 00       	call   396a <exit>
    ...
    exit();
     1e1:	e8 84 37 00 00       	call   396a <exit>
    ...
    exit();
     1f8:	e8 6d 37 00 00       	call   396a <exit>
...
00000200 <exitiputtest>:
{
  ...
  pid = fork();
     216:	e8 47 37 00 00       	call   3962 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 9d 37 00 00       	call   39d2 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 8d 37 00 00       	call   39da <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 55 37 00 00       	call   39ba <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 f9 36 00 00       	call   396a <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 f5 36 00 00       	call   3972 <wait>
  printf(stdout, "exitiput test ok\n");
     ...
     2a6:	e8 25 38 00 00       	call   3ad0 <printf>
      exit();
     2ab:	e8 ba 36 00 00       	call   396a <exit>
    ...
    exit();
     2c2:	e8 a3 36 00 00       	call   396a <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     ...
     2d4:	e8 f7 37 00 00       	call   3ad0 <printf>
      exit();
     2d9:	e8 8c 36 00 00       	call   396a <exit>
     ...
     2eb:	e8 e0 37 00 00       	call   3ad0 <printf>
      exit();
     2f0:	e8 75 36 00 00       	call   396a <exit>
...
00000300 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
     ...
     31d:	e8 b0 36 00 00       	call   39d2 <mkdir>
     322:	83 c4 10             	add    $0x10,%esp
     325:	85 c0                	test   %eax,%eax
     327:	0f 88 9f 00 00 00    	js     3cc <openiputtest+0xcc>
  pid = fork();
     32d:	e8 30 36 00 00       	call   3962 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 63 36 00 00       	call   39aa <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 b5 35 00 00       	call   396a <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
    ...
    exit();
     3c7:	e8 9e 35 00 00       	call   396a <exit>
    ...
    exit();
     3de:	e8 87 35 00 00       	call   396a <exit>
    ...
    exit();
     3f5:	e8 70 35 00 00       	call   396a <exit>
...
00000400 <opentest>:
{
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 86 35 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 5e 35 00 00       	call   3992 <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 f5 3e 00 00       	push   $0x3ef5
     43d:	e8 68 35 00 00       	call   39aa <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
    ...
    exit();
     473:	e8 f2 34 00 00       	call   396a <exit>
    ...
    exit();
     48a:	e8 db 34 00 00       	call   396a <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 f1 34 00 00       	call   39aa <open>
  if(fd >= 0){
  ...
  close(fd);
     ...
     536:	e8 57 34 00 00       	call   3992 <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 3f 3f 00 00       	push   $0x3f3f
     544:	e8 61 34 00 00       	call   39aa <open>
  if(fd >= 0){
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 06 34 00 00       	call   3982 <read>
  if(i == 2000){
  ...
  close(fd);
     ...
     5a0:	e8 ed 33 00 00       	call   3992 <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 3f 3f 00 00 	movl   $0x3f3f,(%esp)
     5ac:	e8 09 34 00 00       	call   39ba <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5e4:	e8 e7 34 00 00       	call   3ad0 <printf>
      exit();
     5e9:	e8 7c 33 00 00       	call   396a <exit>
     ...
     5fd:	e8 ce 34 00 00       	call   3ad0 <printf>
      exit();
     602:	e8 63 33 00 00       	call   396a <exit>
    ...
    exit();
     619:	e8 4c 33 00 00       	call   396a <exit>
    ...
    exit();
     630:	e8 35 33 00 00       	call   396a <exit>
    ...
    exit();
     647:	e8 1e 33 00 00       	call   396a <exit>
    ...
    exit();
     65e:	e8 07 33 00 00       	call   396a <exit>
...
00000670 <writetest1>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 11 33 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 c1 32 00 00       	call   398a <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 a7 32 00 00       	call   3992 <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 87 40 00 00       	push   $0x4087
     6f4:	e8 b1 32 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 48 32 00 00       	call   3982 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 3c 32 00 00       	call   3992 <close>
  if(unlink("big") < 0){
     756:	c7 04 24 87 40 00 00 	movl   $0x4087,(%esp)
     75d:	e8 58 32 00 00       	call   39ba <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     799:	e8 32 33 00 00       	call   3ad0 <printf>
      exit();
     79e:	e8 c7 31 00 00       	call   396a <exit>
     ...
     7b0:	e8 1b 33 00 00       	call   3ad0 <printf>
      exit();
     7b5:	e8 b0 31 00 00       	call   396a <exit>
     ...
     7c9:	e8 02 33 00 00       	call   3ad0 <printf>
      exit();
     7ce:	e8 97 31 00 00       	call   396a <exit>
     ...
     7e4:	e8 e7 32 00 00       	call   3ad0 <printf>
        exit();
     7e9:	e8 7c 31 00 00       	call   396a <exit>
    ...
    exit();
     800:	e8 65 31 00 00       	call   396a <exit>
    ...
    exit();
     817:	e8 4e 31 00 00       	call   396a <exit>
    ...
    exit();
     82e:	e8 37 31 00 00       	call   396a <exit>
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 1f 31 00 00       	call   39aa <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 ff 30 00 00       	call   3992 <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 f4 30 00 00       	call   39ba <unlink>
  for(i = 0; i < 52; i++){
...
000008f0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
     ...
     90d:	e8 c0 30 00 00       	call   39d2 <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 b4 30 00 00       	call   39da <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 9c 30 00 00       	call   39da <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 68 30 00 00       	call   39ba <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
    ...
    exit();
     983:	e8 e2 2f 00 00       	call   396a <exit>
    ...
    exit();
     99a:	e8 cb 2f 00 00       	call   396a <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
    ...
    exit();
     9b1:	e8 b4 2f 00 00       	call   396a <exit>
    ...
    exit();
     9c8:	e8 9d 2f 00 00       	call   396a <exit>
...
000009d0 <exectest>:
{
  ...
  if(exec("echo", echoargv) < 0){
     ...
     9f2:	e8 ab 2f 00 00       	call   39a2 <exec>
    ...
    exit();
     a12:	e8 53 2f 00 00       	call   396a <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 30 2f 00 00       	call   3992 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 05 2f 00 00       	call   3982 <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 b6 2e 00 00       	call   3992 <close>
     ...
     b11:	e8 74 2e 00 00       	call   398a <write>
    ...
    exit();
     b28:	e8 3d 2e 00 00       	call   396a <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 51 2e 00 00       	call   3992 <close>
    wait();
     b41:	e8 2c 2e 00 00       	call   3972 <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 64 2f 00 00       	call   3ad0 <printf>
      exit();
     b6c:	e8 f9 2d 00 00       	call   396a <exit>
    ...
    exit();
     b7f:	e8 e6 2d 00 00       	call   396a <exit>
    ...
    exit();
     b92:	e8 d3 2d 00 00       	call   396a <exit>
     ...
     ba0:	e8 2b 2f 00 00       	call   3ad0 <printf>
        exit();
     ba5:	e8 c0 2d 00 00       	call   396a <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 98 2d 00 00       	call   3962 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 83 2d 00 00       	call   3962 <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 7e 2d 00 00       	call   397a <pipe>
  pid3 = fork();
     bfc:	e8 61 2d 00 00       	call   3962 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[0]);
     ...
     c10:	e8 7d 2d 00 00       	call   3992 <close>
    ...
    close(pfds[1]);
     ...
     c39:	e8 54 2d 00 00       	call   3992 <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 17 2d 00 00       	call   3992 <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 09 2d 00 00       	call   399a <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 01 2d 00 00       	call   399a <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 f9 2c 00 00       	call   399a <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 be 2c 00 00       	call   3972 <wait>
  wait();
     cb4:	e8 b9 2c 00 00       	call   3972 <wait>
  wait();
     cb9:	e8 b4 2c 00 00       	call   3972 <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 4b 2c 00 00       	call   3972 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 2d 2c 00 00       	call   3962 <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 db 2b 00 00       	call   396a <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 3f 2c 00 00       	call   39ea <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 b0 2b 00 00       	call   3962 <fork>
    ...
    exit();
     e1f:	e8 46 2b 00 00       	call   396a <exit>
     ...
     e3a:	e8 5b 2b 00 00       	call   399a <kill>
      exit();
     e3f:	e8 26 2b 00 00       	call   396a <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 1f 2b 00 00       	jmp    3972 <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 39 2b 00 00       	call   39ba <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 33 42 00 00       	push   $0x4233
     e8d:	e8 18 2b 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 b6 2a 00 00       	call   3962 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 67 2a 00 00       	call   3972 <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 79 2a 00 00       	call   3992 <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 33 42 00 00       	push   $0x4233
     f22:	e8 83 2a 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 31 2a 00 00       	call   3982 <read>
  ...
  close(fd);
     ...
     f86:	e8 07 2a 00 00       	call   3992 <close>
  unlink("sharedfd");
     f8b:	c7 04 24 33 42 00 00 	movl   $0x4233,(%esp)
     f92:	e8 23 2a 00 00       	call   39ba <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 6a 29 00 00       	call   396a <exit>
    ...
    exit();
    100e:	e8 57 29 00 00       	call   396a <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 56 29 00 00       	call   39ba <unlink>
    pid = fork();
    1064:	e8 f9 28 00 00       	call   3962 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 e5 28 00 00       	call   3972 <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 de 28 00 00       	call   3972 <wait>
    1094:	e8 d9 28 00 00       	call   3972 <wait>
    1099:	e8 d4 28 00 00       	call   3972 <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 f8 28 00 00       	call   39aa <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 ad 28 00 00       	call   3982 <read>
    ...
    1104:	e8 89 28 00 00       	call   3992 <close>
    if(total != 12*500){
    ...
    111e:	e8 97 28 00 00       	call   39ba <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 72 29 00 00       	call   3ad0 <printf>
          exit();
    115e:	e8 07 28 00 00       	call   396a <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 39 28 00 00       	call   39aa <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 df 27 00 00       	call   398a <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 ab 27 00 00       	call   396a <exit>
    ...
    11c8:	e8 03 29 00 00       	call   3ad0 <printf>
        exit();
    11cd:	e8 98 27 00 00       	call   396a <exit>
    ...
    11e2:	e8 e9 28 00 00       	call   3ad0 <printf>
      exit();
    11e7:	e8 7e 27 00 00       	call   396a <exit>
    ...
    11f5:	e8 d6 28 00 00       	call   3ad0 <printf>
      exit();
    11fa:	e8 6b 27 00 00       	call   396a <exit>
    ...
    1208:	e8 c3 28 00 00       	call   3ad0 <printf>
          exit();
    120d:	e8 58 27 00 00       	call   396a <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 23 27 00 00       	call   3962 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 18 27 00 00       	call   3972 <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 0e 27 00 00       	call   3972 <wait>
    1264:	e8 09 27 00 00       	call   3972 <wait>
    1269:	e8 04 27 00 00       	call   3972 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 fc 26 00 00       	call   39aa <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 c0 26 00 00       	call   3992 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 aa 26 00 00       	call   39ba <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 7e 27 00 00       	call   3ad0 <printf>
        exit();
    1352:	e8 13 26 00 00       	call   396a <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 0b 26 00 00       	call   39aa <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 e3 25 00 00       	call   3992 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 ec 25 00 00       	call   39ba <unlink>
    ...
    13de:	e8 ed 26 00 00       	call   3ad0 <printf>
            exit();
    13e3:	e8 82 25 00 00       	call   396a <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 75 25 00 00       	call   396a <exit>
    ...
    1400:	e8 cb 26 00 00       	call   3ad0 <printf>
        exit();
    1405:	e8 60 25 00 00       	call   396a <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 b7 26 00 00       	call   3ad0 <printf>
      exit();
    1419:	e8 4c 25 00 00       	call   396a <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 a3 26 00 00       	call   3ad0 <printf>
          exit();
    142d:	e8 38 25 00 00       	call   396a <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 45 25 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 08 25 00 00       	call   398a <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 08 25 00 00       	call   3992 <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 e5 42 00 00       	push   $0x42e5
    1493:	e8 12 25 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 08 25 00 00       	call   39ba <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 db 24 00 00       	call   39aa <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 69 24 00 00       	call   398a <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 60 24 00 00       	call   3992 <close>
  unlink("unlinkread");
    1532:	c7 04 24 e5 42 00 00 	movl   $0x42e5,(%esp)
    1539:	e8 7c 24 00 00       	call   39ba <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 01 24 00 00       	call   396a <exit>
    ...
    exit();
    1577:	e8 ee 23 00 00       	call   396a <exit>
    ...
    exit();
    158a:	e8 db 23 00 00       	call   396a <exit>
    ...
    exit();
    159d:	e8 c8 23 00 00       	call   396a <exit>
    ...
    exit();
    15b0:	e8 b5 23 00 00       	call   396a <exit>
    ...
    exit();
    15c3:	e8 a2 23 00 00       	call   396a <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 61 23 00 00       	call   398a <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 54 23 00 00       	call   3992 <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 aa 43 00 00       	push   $0x43aa
    1645:	68 a6 43 00 00       	push   $0x43a6
    164a:	e8 7b 23 00 00       	call   39ca <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 53 23 00 00       	call   39ba <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 a6 43 00 00       	push   $0x43a6
    1670:	e8 35 23 00 00       	call   39aa <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 1b 23 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 d3 22 00 00       	call   3982 <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 ce 22 00 00       	call   3992 <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 aa 43 00 00       	push   $0x43aa
    16cb:	68 aa 43 00 00       	push   $0x43aa
    16d0:	e8 f5 22 00 00       	call   39ca <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 cd 22 00 00       	call   39ba <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 a6 43 00 00       	push   $0x43a6
    16f4:	68 aa 43 00 00       	push   $0x43aa
    16f9:	e8 cc 22 00 00       	call   39ca <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 b3 22 00 00       	call   39ca <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 22 22 00 00       	call   396a <exit>
    ...
    exit();
    1756:	e8 0f 22 00 00       	call   396a <exit>
    ...
    exit();
    1769:	e8 fc 21 00 00       	call   396a <exit>
    ...
    exit();
    177c:	e8 e9 21 00 00       	call   396a <exit>
    ...
    exit();
    178f:	e8 d6 21 00 00       	call   396a <exit>
    ...
    exit();
    17a2:	e8 c3 21 00 00       	call   396a <exit>
    ...
    exit();
    17b5:	e8 b0 21 00 00       	call   396a <exit>
    ...
    exit();
    17c8:	e8 9d 21 00 00       	call   396a <exit>
    ...
    exit();
    17db:	e8 8a 21 00 00       	call   396a <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 7b 21 00 00       	call   39aa <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 50 21 00 00       	call   3992 <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 28 21 00 00       	call   3972 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 58 21 00 00       	call   39ba <unlink>
    pid = fork();
    1862:	e8 fb 20 00 00       	call   3962 <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 20 21 00 00       	call   39aa <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 e9 20 00 00       	call   39ca <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 89 20 00 00       	call   3972 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 97 20 00 00       	call   39aa <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 56 20 00 00       	call   3982 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 19 20 00 00       	call   3992 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 18 20 00 00       	call   39ba <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 10 20 00 00       	call   39ba <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 08 20 00 00       	call   39ba <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 00 20 00 00       	call   39ba <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 a8 1f 00 00       	call   3972 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 81 1f 00 00       	call   3962 <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 9a 1f 00 00       	call   39aa <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 7a 1f 00 00       	call   3992 <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 88 1f 00 00       	call   39aa <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 68 1f 00 00       	call   3992 <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 76 1f 00 00       	call   39aa <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 56 1f 00 00       	call   3992 <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 64 1f 00 00       	call   39aa <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 44 1f 00 00       	call   3992 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 4a 20 00 00       	call   3ad0 <printf>
      exit();
    1a86:	e8 df 1e 00 00       	call   396a <exit>
    ...
    exit();
    1a99:	e8 cc 1e 00 00       	call   396a <exit>
    ...
    1aac:	e8 1f 20 00 00       	call   3ad0 <printf>
        exit();
    1ab1:	e8 b4 1e 00 00       	call   396a <exit>
    ...
    1ac4:	e8 07 20 00 00       	call   3ad0 <printf>
        exit();
    1ac9:	e8 9c 1e 00 00       	call   396a <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 bb 1e 00 00       	call   3992 <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 b9 1e 00 00       	call   39ba <unlink>
  pid = fork();
    1b01:	e8 5c 1e 00 00       	call   3962 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 78 1e 00 00       	call   39ba <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 2f 1e 00 00       	call   39aa <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 0f 1e 00 00       	call   3992 <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 db 1d 00 00       	call   3972 <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 08 1e 00 00       	call   39ca <link>
    ...
    exit();
    1bd8:	e8 8d 1d 00 00       	call   396a <exit>
    exit();
    1bdd:	e8 88 1d 00 00       	call   396a <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 a9 1d 00 00       	call   39ba <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 f5 44 00 00       	push   $0x44f5
    1c1d:	e8 88 1d 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 57 1d 00 00       	call   3992 <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 5e 1d 00 00       	call   39ca <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 2d 1d 00 00       	call   39ba <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 03 1d 00 00       	call   39ba <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 de 1d 00 00       	call   3ad0 <printf>
      exit();
    1cf2:	e8 73 1c 00 00       	call   396a <exit>
    ...
    1d01:	e8 ca 1d 00 00       	call   3ad0 <printf>
      exit();
    1d06:	e8 5f 1c 00 00       	call   396a <exit>
    ...
    exit();
    1d19:	e8 4c 1c 00 00       	call   396a <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 7b 1c 00 00       	call   39ba <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 68 46 00 00 	movl   $0x4668,(%esp)
    1d46:	e8 87 1c 00 00       	call   39d2 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 42 1c 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 05 1c 00 00       	call   398a <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 05 1c 00 00       	call   3992 <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 68 46 00 00 	movl   $0x4668,(%esp)
    1d94:	e8 21 1c 00 00       	call   39ba <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 21 1c 00 00       	call   39d2 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 dc 1b 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 9f 1b 00 00       	call   398a <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 9f 1b 00 00       	call   3992 <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 c2 45 00 00       	push   $0x45c2
    1dfc:	e8 a9 1b 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 61 1b 00 00       	call   3982 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 4f 1b 00 00       	call   3992 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 02 46 00 00       	push   $0x4602
    1e4a:	68 9e 45 00 00       	push   $0x459e
    1e4f:	e8 76 1b 00 00       	call   39ca <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 4e 1b 00 00       	call   39ba <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 24 1b 00 00       	call   39aa <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 3c 1b 00 00       	call   39da <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 24 1b 00 00       	call   39da <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 0c 1b 00 00       	call   39da <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 f4 1a 00 00       	call   39da <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 aa 1a 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 62 1a 00 00       	call   3982 <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 5d 1a 00 00       	call   3992 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 9e 45 00 00       	push   $0x459e
    1f3e:	e8 67 1a 00 00       	call   39aa <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 4a 1a 00 00       	call   39aa <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 2d 1a 00 00       	call   39aa <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 10 1a 00 00       	call   39aa <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 f6 19 00 00       	call   39aa <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 dc 19 00 00       	call   39aa <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 df 19 00 00       	call   39ca <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 c2 19 00 00       	call   39ca <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 a5 19 00 00       	call   39ca <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 95 19 00 00       	call   39d2 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 7d 19 00 00       	call   39d2 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 65 19 00 00       	call   39d2 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 35 19 00 00       	call   39ba <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 1d 19 00 00       	call   39ba <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 25 19 00 00       	call   39da <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 0d 19 00 00       	call   39da <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 d5 18 00 00       	call   39ba <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 bd 18 00 00       	call   39ba <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 a5 18 00 00       	call   39ba <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 8d 18 00 00       	call   39ba <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 75 18 00 00       	call   39ba <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 f0 17 00 00       	call   396a <exit>
    ...
    exit();
    2188:	e8 dd 17 00 00       	call   396a <exit>
    ...
    exit();
    219b:	e8 ca 17 00 00       	call   396a <exit>
    ...
    exit();
    21ae:	e8 b7 17 00 00       	call   396a <exit>
    ...
    exit();
    21c1:	e8 a4 17 00 00       	call   396a <exit>
    ...
    exit();
    21d4:	e8 91 17 00 00       	call   396a <exit>
    ...
    exit();
    21e7:	e8 7e 17 00 00       	call   396a <exit>
    ...
    exit();
    21fa:	e8 6b 17 00 00       	call   396a <exit>
    ...
    exit();
    220d:	e8 58 17 00 00       	call   396a <exit>
    ...
    exit();
    2220:	e8 45 17 00 00       	call   396a <exit>
    ...
    exit();
    2233:	e8 32 17 00 00       	call   396a <exit>
    ...
    exit();
    2246:	e8 1f 17 00 00       	call   396a <exit>
    ...
    exit();
    2259:	e8 0c 17 00 00       	call   396a <exit>
    ...
    exit();
    226c:	e8 f9 16 00 00       	call   396a <exit>
    ...
    exit();
    227f:	e8 e6 16 00 00       	call   396a <exit>
    ...
    exit();
    2292:	e8 d3 16 00 00       	call   396a <exit>
    ...
    exit();
    22a5:	e8 c0 16 00 00       	call   396a <exit>
    ...
    exit();
    22b8:	e8 ad 16 00 00       	call   396a <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 9a 16 00 00       	call   396a <exit>
    ...
    exit();
    22de:	e8 87 16 00 00       	call   396a <exit>
    ...
    exit();
    22f1:	e8 74 16 00 00       	call   396a <exit>
    ...
    exit();
    2304:	e8 61 16 00 00       	call   396a <exit>
    ...
    exit();
    2317:	e8 4e 16 00 00       	call   396a <exit>
    ...
    exit();
    232a:	e8 3b 16 00 00       	call   396a <exit>
    ...
    exit();
    233d:	e8 28 16 00 00       	call   396a <exit>
    ...
    exit();
    2350:	e8 15 16 00 00       	call   396a <exit>
    ...
    exit();
    2363:	e8 02 16 00 00       	call   396a <exit>
    ...
    exit();
    2376:	e8 ef 15 00 00       	call   396a <exit>
    ...
    exit();
    2389:	e8 dc 15 00 00       	call   396a <exit>
    ...
    exit();
    239c:	e8 c9 15 00 00       	call   396a <exit>
    ...
    exit();
    23af:	e8 b6 15 00 00       	call   396a <exit>
    ...
    exit();
    23c2:	e8 a3 15 00 00       	call   396a <exit>
    ...
    exit();
    23d5:	e8 90 15 00 00       	call   396a <exit>
    ...
    exit();
    23e8:	e8 7d 15 00 00       	call   396a <exit>
    ...
    exit();
    23fb:	e8 6a 15 00 00       	call   396a <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 95 15 00 00       	call   39ba <unlink>
    ...
    243d:	e8 68 15 00 00       	call   39aa <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 30 15 00 00       	call   398a <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 1a 15 00 00       	call   398a <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 0c 15 00 00       	call   3992 <close>
    unlink("bigwrite");
    2486:	c7 04 24 64 48 00 00 	movl   $0x4864,(%esp)
    248d:	e8 28 15 00 00       	call   39ba <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 0c 16 00 00       	call   3ad0 <printf>
        exit();
    24c4:	e8 a1 14 00 00       	call   396a <exit>
    ...
    24d3:	e8 f8 15 00 00       	call   3ad0 <printf>
      exit();
    24d8:	e8 8d 14 00 00       	call   396a <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 b9 14 00 00       	call   39ba <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 c0 48 00 00       	push   $0x48c0
    250d:	e8 98 14 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 3c 14 00 00       	call   398a <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 25 14 00 00       	call   3992 <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 c0 48 00 00       	push   $0x48c0
    2576:	e8 2f 14 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 b1 13 00 00       	call   3982 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 af 13 00 00       	call   3992 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 bb 13 00 00       	call   39ba <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 a9 14 00 00       	call   3ad0 <printf>
      exit();
    2627:	e8 3e 13 00 00       	call   396a <exit>
    ...
    2636:	e8 95 14 00 00       	call   3ad0 <printf>
      exit();
    263b:	e8 2a 13 00 00       	call   396a <exit>
    ...
    264a:	e8 81 14 00 00       	call   3ad0 <printf>
      exit();
    264f:	e8 16 13 00 00       	call   396a <exit>
    ...
    265e:	e8 6d 14 00 00       	call   3ad0 <printf>
      exit();
    2663:	e8 02 13 00 00       	call   396a <exit>
    ...
    exit();
    2676:	e8 ef 12 00 00       	call   396a <exit>
    ...
    exit();
    2689:	e8 dc 12 00 00       	call   396a <exit>
    ...
    exit();
    269c:	e8 c9 12 00 00       	call   396a <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 04 13 00 00       	call   39d2 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 ec 12 00 00       	call   39d2 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 a7 12 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 7b 12 00 00       	call   3992 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 18 52 00 00       	push   $0x5218
    2720:	e8 85 12 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 5d 12 00 00       	call   3992 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 8c 49 00 00 	movl   $0x498c,(%esp)
    273c:	e8 91 12 00 00       	call   39d2 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 7d 12 00 00       	call   39d2 <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 e7 11 00 00       	call   396a <exit>
    ...
    exit();
    2791:	e8 d4 11 00 00       	call   396a <exit>
    ...
    exit();
    27a4:	e8 c1 11 00 00       	call   396a <exit>
    ...
    exit();
    27b7:	e8 ae 11 00 00       	call   396a <exit>
    ...
    exit();
    27ca:	e8 9b 11 00 00       	call   396a <exit>
    ...
    exit();
    27dd:	e8 88 11 00 00       	call   396a <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 c4 11 00 00       	call   39d2 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 b4 11 00 00       	call   39da <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 7c 11 00 00       	call   39ba <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 64 11 00 00       	call   39ba <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 6c 11 00 00       	call   39da <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 34 11 00 00       	call   39ba <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 20 11 00 00       	call   39ba <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 0c 11 00 00       	call   39ba <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 8e 10 00 00       	call   396a <exit>
    ...
    exit();
    28ea:	e8 7b 10 00 00       	call   396a <exit>
    ...
    exit();
    28fd:	e8 68 10 00 00       	call   396a <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 55 10 00 00       	call   396a <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 42 10 00 00       	call   396a <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 2f 10 00 00       	call   396a <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 1c 10 00 00       	call   396a <exit>
    ...
    exit();
    295c:	e8 09 10 00 00       	call   396a <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 16 10 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 ea 0f 00 00       	call   3992 <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 75 4a 00 00 	movl   $0x4a75,(%esp)
    29af:	e8 26 10 00 00       	call   39da <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 dc 0f 00 00       	call   39aa <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 bf 0f 00 00       	call   39aa <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 cf 0f 00 00       	call   39d2 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 9f 0f 00 00       	call   39ba <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 92 0f 00 00       	call   39ca <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 6a 0f 00 00       	call   39ba <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 40 0f 00 00       	call   39aa <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 26 0f 00 00       	call   39aa <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 f4 0e 00 00       	call   398a <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 ec 0e 00 00       	call   3992 <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 9b 0e 00 00       	call   396a <exit>
    ...
    exit();
    2add:	e8 88 0e 00 00       	call   396a <exit>
    ...
    exit();
    2af0:	e8 75 0e 00 00       	call   396a <exit>
    ...
    exit();
    2b03:	e8 62 0e 00 00       	call   396a <exit>
    ...
    exit();
    2b16:	e8 4f 0e 00 00       	call   396a <exit>
    ...
    exit();
    2b29:	e8 3c 0e 00 00       	call   396a <exit>
    ...
    exit();
    2b3c:	e8 29 0e 00 00       	call   396a <exit>
    ...
    exit();
    2b4f:	e8 16 0e 00 00       	call   396a <exit>
    ...
    exit();
    2b62:	e8 03 0e 00 00       	call   396a <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 35 0e 00 00       	call   39d2 <mkdir>
    ...
    2bb0:	e8 25 0e 00 00       	call   39da <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 6e 0d 00 00       	call   3992 <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 50 47 00 00       	push   $0x4750
    2c2f:	e8 86 0d 00 00       	call   39ba <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 8d 0d 00 00       	call   39da <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 5e 0e 00 00       	call   3ad0 <printf>
      exit();
    2c72:	e8 f3 0c 00 00       	call   396a <exit>
    ...
    2c81:	e8 4a 0e 00 00       	call   3ad0 <printf>
      exit();
    2c86:	e8 df 0c 00 00       	call   396a <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 a0 0c 00 00       	call   3962 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 9d 0c 00 00       	call   3972 <wait>
  ...
  if(wait() != -1){
    2cde:	e8 8f 0c 00 00       	call   3972 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 69 0c 00 00       	call   396a <exit>
    ...
    2d0b:	e8 c0 0d 00 00       	call   3ad0 <printf>
      exit();
    2d10:	e8 55 0c 00 00       	call   396a <exit>
    ...
    exit();
    2d23:	e8 42 0c 00 00       	call   396a <exit>
    ...
    exit();
    2d36:	e8 2f 0c 00 00       	call   396a <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  oldbrk = sbrk(0);
    ...
    2d62:	e8 8b 0c 00 00       	call   39f2 <sbrk>
  a = sbrk(0);
    2d67:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2d6e:	89 45 a4             	mov    %eax,-0x5c(%ebp)
  a = sbrk(0);
    2d71:	e8 7c 0c 00 00       	call   39f2 <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 66 0c 00 00       	call   39f2 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 b5 0b 00 00       	call   3962 <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 2e 0c 00 00       	call   39f2 <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 22 0c 00 00       	call   39f2 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 8a 0b 00 00       	call   3972 <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 00 0c 00 00       	call   39f2 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 ef 0b 00 00       	call   39f2 <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 da 0b 00 00       	call   39f2 <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 cc 0b 00 00       	call   39f2 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 b6 0b 00 00       	call   39f2 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 9b 0b 00 00       	call   39f2 <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 8d 0b 00 00       	call   39f2 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 76 0b 00 00       	call   39f2 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 0d 0b 00 00       	call   39ea <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 7e 0a 00 00       	call   3962 <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 7b 0a 00 00       	call   3972 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 69 0a 00 00       	call   397a <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 35 0a 00 00       	call   3962 <fork>
    ...
    2f48:	e8 35 0a 00 00       	call   3982 <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 8e 0a 00 00       	call   39f2 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 1a 0a 00 00       	call   399a <kill>
    wait();
    2f80:	e8 ed 09 00 00       	call   3972 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 50 0a 00 00       	call   39f2 <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fb2:	ff 35 8c 5f 00 00    	push   0x5f8c
    ...
    304c:	e8 19 09 00 00       	call   396a <exit>
      printf(stdout, "fork failed\n");
    ...
    305f:	e8 6c 0a 00 00       	call   3ad0 <printf>
      exit();
    3064:	e8 01 09 00 00       	call   396a <exit>
    ...
    3081:	e8 14 09 00 00       	call   399a <kill>
      exit();
    3086:	e8 df 08 00 00       	call   396a <exit>
    ...
    exit();
    309d:	e8 c8 08 00 00       	call   396a <exit>
    ...
    exit();
    30b4:	e8 b1 08 00 00       	call   396a <exit>
    ...
    exit();
    30cb:	e8 9a 08 00 00       	call   396a <exit>
    ...
    exit();
    30e2:	e8 83 08 00 00       	call   396a <exit>
    ...
    exit();
    30f9:	e8 6c 08 00 00       	call   396a <exit>
    printf(1, "pipe() failed\n");
    30fe:	52                   	push   %edx
    30ff:	52                   	push   %edx
    ...
    exit();
    310c:	e8 59 08 00 00       	call   396a <exit>
    exit();
    3111:	e8 54 08 00 00       	call   396a <exit>
    ...
    exit();
    3128:	e8 3d 08 00 00       	call   396a <exit>
    ...
    exit();
    313f:	e8 26 08 00 00       	call   396a <exit>
    ...
    exit();
    3156:	e8 0f 08 00 00       	call   396a <exit>
    ...
    exit();
    316d:	e8 f8 07 00 00       	call   396a <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    if((pid = fork()) == 0){
    31b0:	e8 ad 07 00 00       	call   3962 <fork>
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 35 08 00 00       	call   39fa <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 29 08 00 00       	call   39fa <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 c1 07 00 00       	call   399a <kill>
    wait();
    31d9:	e8 94 07 00 00       	call   3972 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 ad 4c 00 00       	push   $0x4cad
    31e6:	e8 df 07 00 00       	call   39ca <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 47 07 00 00       	call   396a <exit>
    ...
    3231:	e8 9a 08 00 00       	call   3ad0 <printf>
      exit();
    3236:	e8 2f 07 00 00       	call   396a <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test ok\n");
    ...
    3299:	e8 32 08 00 00       	call   3ad0 <printf>
      exit();
    329e:	e8 c7 06 00 00       	call   396a <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 fa 06 00 00       	call   39ba <unlink>
  pid = fork();
    32c0:	e8 9d 06 00 00       	call   3962 <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 9b 06 00 00       	call   3972 <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 06 4d 00 00       	push   $0x4d06
    32e1:	e8 c4 06 00 00       	call   39aa <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 98 06 00 00       	call   3992 <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 06 4d 00 00 	movl   $0x4d06,(%esp)
    3301:	e8 b4 06 00 00       	call   39ba <unlink>
}
    ...
    3310:	c7 04 85 e0 a6 00 00 	movl   $0x5460,0xa6e0(,%eax,4)
    3317:	60 54 00 00 
    ...
    334b:	e8 52 06 00 00       	call   39a2 <exec>
    ...
    336e:	e8 37 06 00 00       	call   39aa <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 17 06 00 00       	call   3992 <close>
    exit();
    337b:	e8 ea 05 00 00       	call   396a <exit>
    ...
    exit();
    3392:	e8 d3 05 00 00       	call   396a <exit>
    ...
    exit();
    33a9:	e8 bc 05 00 00       	call   396a <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 4c 05 00 00       	call   39aa <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 05 05 00 00       	call   398a <write>
      if(cc < 512)
    ...
    34a2:	e8 eb 04 00 00       	call   3992 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 69 04 00 00       	call   39ba <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 cb 03 00 00       	call   3962 <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 cd 03 00 00       	call   3972 <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 8d 03 00 00       	call   396a <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 7a 03 00 00       	call   396a <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 a7 03 00 00       	call   39aa <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 dc 03 00 00       	call   39f2 <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 5d 03 00 00       	call   3982 <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 65 03 00 00       	call   3992 <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3651:	e8 14 03 00 00       	call   396a <exit>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 c5 01 00 00       	call   3982 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 88 01 00 00       	call   39aa <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 8b 01 00 00       	call   39c2 <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 51 01 00 00       	call   3992 <close>
  return r;
...
lock_init(lock_t *spinlock)
{
  ...
  spinlock->acquired = 0;
    ...
    38d6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    38dc:	5d                   	pop    %ebp
    38dd:	c3                   	ret    
...
xchg(volatile uint *addr, uint newval)
{
  ...
  asm volatile("lock; xchgl %0, %1" :
    38e1:	b9 01 00 00 00       	mov    $0x1,%ecx
    38e6:	89 e5                	mov    %esp,%ebp
    38e8:	8b 55 08             	mov    0x8(%ebp),%edx
    38eb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    38ef:	90                   	nop
    38f0:	89 c8                	mov    %ecx,%eax
    38f2:	f0 87 02             	lock xchg %eax,(%edx)
  while (xchg((volatile uint *)&spinlock->acquired, 1) == 1)
    38f5:	83 f8 01             	cmp    $0x1,%eax
    38f8:	74 f6                	je     38f0 <lock_acquire+0x10>
    ; // spin
}
    38fa:	5d                   	pop    %ebp
    38fb:	c3                   	ret    
...
lock_release(lock_t *spinlock)
{
    ...
    3905:	8b 55 08             	mov    0x8(%ebp),%edx
    3908:	f0 87 02             	lock xchg %eax,(%edx)
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
    ...
    3913:	83 ec 14             	sub    $0x14,%esp
  void* stack = malloc(2*4096);
    3916:	68 00 20 00 00       	push   $0x2000
    391b:	e8 e0 03 00 00       	call   3d00 <malloc>
  original_stack = *(uint*)(stack);
    3920:	8b 10                	mov    (%eax),%edx
  ...
  original_stack = *(uint*)(stack);
    392c:	89 15 60 a7 00 00    	mov    %edx,0xa760
  return clone(start_routine, arg1, arg2, stack);
    3932:	e8 db 00 00 00       	call   3a12 <clone>
}
    3937:	c9                   	leave  
    3938:	c3                   	ret    
...
int thread_join(void){
  ...
  wait_pid = join(&stack);
    394a:	50                   	push   %eax
    394b:	e8 ba 00 00 00       	call   3a0a <join>
    3950:	89 c3                	mov    %eax,%ebx
  free(stack);
    3952:	58                   	pop    %eax
    3953:	ff 75 f4             	push   -0xc(%ebp)
    3956:	e8 15 03 00 00       	call   3c70 <free>
  return wait_pid;
    395b:	89 d8                	mov    %ebx,%eax
    395d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3960:	c9                   	leave  
    3961:	c3                   	ret    
...
SYSCALL(fork)
    3962:	b8 01 00 00 00       	mov    $0x1,%eax
    3967:	cd 40                	int    $0x40
    3969:	c3                   	ret    

0000396a <exit>:
SYSCALL(exit)
    396a:	b8 02 00 00 00       	mov    $0x2,%eax
    396f:	cd 40                	int    $0x40
    3971:	c3                   	ret    

00003972 <wait>:
SYSCALL(wait)
    3972:	b8 03 00 00 00       	mov    $0x3,%eax
    3977:	cd 40                	int    $0x40
    3979:	c3                   	ret    

0000397a <pipe>:
SYSCALL(pipe)
    397a:	b8 04 00 00 00       	mov    $0x4,%eax
    397f:	cd 40                	int    $0x40
    3981:	c3                   	ret    

00003982 <read>:
SYSCALL(read)
    3982:	b8 05 00 00 00       	mov    $0x5,%eax
    3987:	cd 40                	int    $0x40
    3989:	c3                   	ret    
...
00003992 <close>:
SYSCALL(close)
    3992:	b8 15 00 00 00       	mov    $0x15,%eax
    3997:	cd 40                	int    $0x40
    3999:	c3                   	ret    

0000399a <kill>:
SYSCALL(kill)
    399a:	b8 06 00 00 00       	mov    $0x6,%eax
    399f:	cd 40                	int    $0x40
    39a1:	c3                   	ret    

000039a2 <exec>:
SYSCALL(exec)
    39a2:	b8 07 00 00 00       	mov    $0x7,%eax
    39a7:	cd 40                	int    $0x40
    39a9:	c3                   	ret    

000039aa <open>:
SYSCALL(open)
    39aa:	b8 0f 00 00 00       	mov    $0xf,%eax
    39af:	cd 40                	int    $0x40
    39b1:	c3                   	ret    

000039b2 <mknod>:
SYSCALL(mknod)
    39b2:	b8 11 00 00 00       	mov    $0x11,%eax
    39b7:	cd 40                	int    $0x40
    39b9:	c3                   	ret    

000039ba <unlink>:
SYSCALL(unlink)
    39ba:	b8 12 00 00 00       	mov    $0x12,%eax
    39bf:	cd 40                	int    $0x40
    39c1:	c3                   	ret    

000039c2 <fstat>:
SYSCALL(fstat)
    39c2:	b8 08 00 00 00       	mov    $0x8,%eax
    39c7:	cd 40                	int    $0x40
    39c9:	c3                   	ret    

000039ca <link>:
SYSCALL(link)
    39ca:	b8 13 00 00 00       	mov    $0x13,%eax
    39cf:	cd 40                	int    $0x40
    39d1:	c3                   	ret    

000039d2 <mkdir>:
SYSCALL(mkdir)
    39d2:	b8 14 00 00 00       	mov    $0x14,%eax
    39d7:	cd 40                	int    $0x40
    39d9:	c3                   	ret    

000039da <chdir>:
SYSCALL(chdir)
    39da:	b8 09 00 00 00       	mov    $0x9,%eax
    39df:	cd 40                	int    $0x40
    39e1:	c3                   	ret    

000039e2 <dup>:
SYSCALL(dup)
    39e2:	b8 0a 00 00 00       	mov    $0xa,%eax
    39e7:	cd 40                	int    $0x40
    39e9:	c3                   	ret    

000039ea <getpid>:
SYSCALL(getpid)
    39ea:	b8 0b 00 00 00       	mov    $0xb,%eax
    39ef:	cd 40                	int    $0x40
    39f1:	c3                   	ret    

000039f2 <sbrk>:
SYSCALL(sbrk)
    39f2:	b8 0c 00 00 00       	mov    $0xc,%eax
    39f7:	cd 40                	int    $0x40
    39f9:	c3                   	ret    

000039fa <sleep>:
SYSCALL(sleep)
    39fa:	b8 0d 00 00 00       	mov    $0xd,%eax
    39ff:	cd 40                	int    $0x40
    3a01:	c3                   	ret    

00003a02 <uptime>:
SYSCALL(uptime)
    3a02:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a07:	cd 40                	int    $0x40
    3a09:	c3                   	ret    
    ...
    3a2c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a9e:	56                   	push   %esi
    3a9f:	57                   	push   %edi
    3aa0:	e8 e5 fe ff ff       	call   398a <write>
  while(--i >= 0)
    ...
    3ad9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3b15:	57                   	push   %edi
    3b16:	56                   	push   %esi
    3b17:	e8 6e fe ff ff       	call   398a <write>
  ...
  write(fd, &c, 1);
    ...
    3b6e:	e8 17 fe ff ff       	call   398a <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b7f:	57                   	push   %edi
    3b80:	56                   	push   %esi
    3b81:	e8 04 fe ff ff       	call   398a <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3beb:	57                   	push   %edi
    3bec:	56                   	push   %esi
    3bed:	e8 98 fd ff ff       	call   398a <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c2f:	e8 56 fd ff ff       	call   398a <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c71:	a1 64 a7 00 00       	mov    0xa764,%eax
{
  ...
  freep = p;
    ...
    3cb1:	5b                   	pop    %ebx
  freep = p;
    3cb2:	89 15 64 a7 00 00    	mov    %edx,0xa764
}
    3cb8:	5e                   	pop    %esi
    3cb9:	5f                   	pop    %edi
    3cba:	5d                   	pop    %ebp
  ...
  freep = p;
    3cec:	89 15 64 a7 00 00    	mov    %edx,0xa764
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d0c:	8b 3d 64 a7 00 00    	mov    0xa764,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3d51:	8b 3d 64 a7 00 00    	mov    0xa764,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d63:	e8 8a fc ff ff       	call   39f2 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3d7f:	8b 15 64 a7 00 00    	mov    0xa764,%edx
    ...
    3dac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3daf:	89 15 64 a7 00 00    	mov    %edx,0xa764
}
    ...
    3dbf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3dc0:	c7 05 64 a7 00 00 68 	movl   $0xa768,0xa764
    3dc7:	a7 00 00 
    base.s.size = 0;
    3dca:	bf 68 a7 00 00       	mov    $0xa768,%edi
    base.s.ptr = freep = prevp = &base;
    3dcf:	c7 05 68 a7 00 00 68 	movl   $0xa768,0xa768
    3dd6:	a7 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3dd9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3ddb:	c7 05 6c a7 00 00 00 	movl   $0x0,0xa76c
    3de2:	00 00 00 
    if(p->s.size >= nunits){
