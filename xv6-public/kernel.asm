...
80102088:	68 a6 7b 10 80       	push   $0x80107ba6
...
80103824:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 1f 5b 10 80 	movl   $0x80105b1f,0x14(%eax)
  p->context = (struct context*)sp;
...
801038d6:	68 a0 79 10 80       	push   $0x801079a0
...
801039b3:	e8 58 37 00 00       	call   80107110 <setupkvm>
...
801039d1:	e8 ea 33 00 00       	call   80106dc0 <inituvm>
...
80103a3f:	68 d0 79 10 80       	push   $0x801079d0
80103a44:	50                   	push   %eax
80103a45:	e8 46 10 00 00       	call   80104a90 <safestrcpy>
  p->cwd = namei("/");
80103a4a:	c7 04 24 d9 79 10 80 	movl   $0x801079d9,(%esp)
...
80103a83:	68 b7 79 10 80       	push   $0x801079b7
...
80103abb:	e8 f0 31 00 00       	call   80106cb0 <switchuvm>
  return 0;
...
80103b48:	e8 b3 36 00 00       	call   80107200 <copyuvm>
...
80103c43:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c49:	e8 c2 0a 00 00       	call   80104710 <popcli>
  if((np = allocproc()) == 0){
80103c4e:	e8 5d fb ff ff       	call   801037b0 <allocproc>
80103c53:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103c56:	85 c0                	test   %eax,%eax
80103c58:	0f 84 cc 00 00 00    	je     80103d2a <clone+0xfa>
80103c5e:	89 c1                	mov    %eax,%ecx
  if((np->pgdir = curproc->pgdir) == 0){
80103c60:	8b 43 04             	mov    0x4(%ebx),%eax
80103c63:	8b 55 14             	mov    0x14(%ebp),%edx
80103c66:	85 c0                	test   %eax,%eax
80103c68:	89 41 04             	mov    %eax,0x4(%ecx)
80103c6b:	0f 84 c0 00 00 00    	je     80103d31 <clone+0x101>
  np->sz = curproc->sz;
80103c71:	8b 03                	mov    (%ebx),%eax
80103c73:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  *np->tf = *curproc->tf;
80103c76:	b9 13 00 00 00       	mov    $0x13,%ecx
  stack = stack + PGSIZE;
80103c7b:	81 c2 00 10 00 00    	add    $0x1000,%edx
  np->sz = curproc->sz;
80103c81:	89 07                	mov    %eax,(%edi)
  *((uint*)stack - 8) = (uint)arg2;
80103c83:	8b 45 10             	mov    0x10(%ebp),%eax
  np->parent = curproc;
80103c86:	89 5f 18             	mov    %ebx,0x18(%edi)
  *np->tf = *curproc->tf;
80103c89:	8b 7f 1c             	mov    0x1c(%edi),%edi
80103c8c:	8b 73 1c             	mov    0x1c(%ebx),%esi
80103c8f:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  *((uint*)stack - 8) = (uint)arg2;
80103c91:	89 42 e0             	mov    %eax,-0x20(%edx)
  np->tf->eip = (uint)fcn;
80103c94:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  for(i = 0; i < NOFILE; i++)
80103c97:	31 f6                	xor    %esi,%esi
  *((uint*)stack - 4) = (uint)arg1;
80103c99:	8b 45 0c             	mov    0xc(%ebp),%eax
  np->tf->eip = (uint)fcn;
80103c9c:	8b 4d 08             	mov    0x8(%ebp),%ecx
  *((uint*)stack) = 0xffffffff;
80103c9f:	c7 02 ff ff ff ff    	movl   $0xffffffff,(%edx)
  *((uint*)stack - 4) = (uint)arg1;
80103ca5:	89 42 f0             	mov    %eax,-0x10(%edx)
  np->tf->eip = (uint)fcn;
80103ca8:	8b 47 1c             	mov    0x1c(%edi),%eax
80103cab:	89 48 38             	mov    %ecx,0x38(%eax)
  stack = stack + PGSIZE;
80103cae:	89 57 0c             	mov    %edx,0xc(%edi)
  for(i = 0; i < NOFILE; i++)
80103cb1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[i])
80103cb8:	8b 44 b3 2c          	mov    0x2c(%ebx,%esi,4),%eax
80103cbc:	85 c0                	test   %eax,%eax
80103cbe:	74 10                	je     80103cd0 <clone+0xa0>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103cc0:	83 ec 0c             	sub    $0xc,%esp
80103cc3:	50                   	push   %eax
80103cc4:	e8 d7 d1 ff ff       	call   80100ea0 <filedup>
80103cc9:	83 c4 10             	add    $0x10,%esp
80103ccc:	89 44 b7 2c          	mov    %eax,0x2c(%edi,%esi,4)
  for(i = 0; i < NOFILE; i++)
80103cd0:	83 c6 01             	add    $0x1,%esi
80103cd3:	83 fe 10             	cmp    $0x10,%esi
80103cd6:	75 e0                	jne    80103cb8 <clone+0x88>
  np->cwd = idup(curproc->cwd);
80103cd8:	83 ec 0c             	sub    $0xc,%esp
80103cdb:	ff 73 6c             	push   0x6c(%ebx)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103cde:	83 c3 70             	add    $0x70,%ebx
  np->cwd = idup(curproc->cwd);
80103ce1:	e8 6a da ff ff       	call   80101750 <idup>
80103ce6:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103ce9:	83 c4 0c             	add    $0xc,%esp
  np->cwd = idup(curproc->cwd);
80103cec:	89 47 6c             	mov    %eax,0x6c(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103cef:	8d 47 70             	lea    0x70(%edi),%eax
80103cf2:	6a 10                	push   $0x10
80103cf4:	53                   	push   %ebx
80103cf5:	50                   	push   %eax
80103cf6:	e8 95 0d 00 00       	call   80104a90 <safestrcpy>
  pid = np->pid;
80103cfb:	8b 5f 14             	mov    0x14(%edi),%ebx
  acquire(&ptable.lock);
80103cfe:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103d05:	e8 06 0b 00 00       	call   80104810 <acquire>
  np->state = RUNNABLE;
80103d0a:	c7 47 10 03 00 00 00 	movl   $0x3,0x10(%edi)
  release(&ptable.lock);
80103d11:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103d18:	e8 93 0a 00 00       	call   801047b0 <release>
  return pid;
...
80103d29:	c3                   	ret    
    return -1;
80103d2a:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103d2f:	eb ef                	jmp    80103d20 <clone+0xf0>
    kfree(np->kstack);
80103d31:	83 ec 0c             	sub    $0xc,%esp
80103d34:	ff 71 08             	push   0x8(%ecx)
80103d37:	89 cb                	mov    %ecx,%ebx
80103d39:	e8 82 e7 ff ff       	call   801024c0 <kfree>
    np->kstack = 0;
80103d3e:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    return -1;
80103d45:	83 c4 10             	add    $0x10,%esp
    np->state = UNUSED;
80103d48:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
    return -1;
80103d4f:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80103d54:	eb ca                	jmp    80103d20 <clone+0xf0>
...
80103db0:	e8 fb 2e 00 00       	call   80106cb0 <switchuvm>
...
80103dc2:	e8 24 0d 00 00       	call   80104aeb <swtch>
      switchkvm();
80103dc7:	e8 d4 2e 00 00       	call   80106ca0 <switchkvm>
      c->proc = 0;
...
80103fcd:	68 28 7a 10 80       	push   $0x80107a28
80103fd2:	e8 a9 c3 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103fd7:	83 ec 0c             	sub    $0xc,%esp
80103fda:	68 1b 7a 10 80       	push   $0x80107a1b
...
8010401a:	8b 46 04             	mov    0x4(%esi),%eax
    havekids = 0;
8010401d:	31 d2                	xor    %edx,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010401f:	bb 54 1d 11 80       	mov    $0x80111d54,%ebx
80104024:	eb 15                	jmp    8010403b <wait+0x4b>
...
80104039:	74 20                	je     8010405b <wait+0x6b>
      if(p->pgdir == curproc->pgdir || p->parent != curproc)
8010403b:	39 43 04             	cmp    %eax,0x4(%ebx)
8010403e:	74 f0                	je     80104030 <wait+0x40>
80104040:	39 73 18             	cmp    %esi,0x18(%ebx)
80104043:	75 eb                	jne    80104030 <wait+0x40>
      if(p->state == ZOMBIE){
80104045:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
80104049:	74 65                	je     801040b0 <wait+0xc0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010404b:	83 eb 80             	sub    $0xffffff80,%ebx
      havekids = 1;
8010404e:	ba 01 00 00 00       	mov    $0x1,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104053:	81 fb 54 3d 11 80    	cmp    $0x80113d54,%ebx
80104059:	75 e0                	jne    8010403b <wait+0x4b>
    if(!havekids || curproc->killed){
8010405b:	85 d2                	test   %edx,%edx
8010405d:	0f 84 a3 00 00 00    	je     80104106 <wait+0x116>
80104063:	8b 46 28             	mov    0x28(%esi),%eax
80104066:	85 c0                	test   %eax,%eax
80104068:	0f 85 98 00 00 00    	jne    80104106 <wait+0x116>
  pushcli();
8010406e:	e8 4d 06 00 00       	call   801046c0 <pushcli>
  c = mycpu();
80104073:	e8 78 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104078:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010407e:	e8 8d 06 00 00       	call   80104710 <popcli>
  if(p == 0)
80104083:	85 db                	test   %ebx,%ebx
80104085:	0f 84 92 00 00 00    	je     8010411d <wait+0x12d>
  p->chan = chan;
8010408b:	89 73 24             	mov    %esi,0x24(%ebx)
  p->state = SLEEPING;
8010408e:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80104095:	e8 66 fd ff ff       	call   80103e00 <sched>
  p->chan = 0;
8010409a:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
}
801040a1:	e9 74 ff ff ff       	jmp    8010401a <wait+0x2a>
801040a6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801040ad:	8d 76 00             	lea    0x0(%esi),%esi
        kfree(p->kstack);
801040b0:	83 ec 0c             	sub    $0xc,%esp
        pid = p->pid;
801040b3:	8b 73 14             	mov    0x14(%ebx),%esi
        kfree(p->kstack);
801040b6:	ff 73 08             	push   0x8(%ebx)
801040b9:	e8 02 e4 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
801040be:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801040c5:	5a                   	pop    %edx
801040c6:	ff 73 04             	push   0x4(%ebx)
801040c9:	e8 c2 2f 00 00       	call   80107090 <freevm>
        p->pid = 0;
801040ce:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
801040d5:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
801040dc:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
801040e0:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->state = UNUSED;
801040e7:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
801040ee:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
...
80104109:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010410e:	68 20 1d 11 80       	push   $0x80111d20
80104113:	e8 98 06 00 00       	call   801047b0 <release>
      return -1;
80104118:	83 c4 10             	add    $0x10,%esp
8010411b:	eb e0                	jmp    801040fd <wait+0x10d>
    panic("sleep");
8010411d:	83 ec 0c             	sub    $0xc,%esp
80104120:	68 34 7a 10 80       	push   $0x80107a34
...
80104161:	eb 10                	jmp    80104173 <join+0x43>
...
80104171:	74 1b                	je     8010418e <join+0x5e>
      if(p->parent != curproc)
80104173:	39 73 18             	cmp    %esi,0x18(%ebx)
80104176:	75 f0                	jne    80104168 <join+0x38>
      if(p->state == ZOMBIE){
80104178:	83 7b 10 05          	cmpl   $0x5,0x10(%ebx)
8010417c:	74 62                	je     801041e0 <join+0xb0>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
8010418c:	75 e5                	jne    80104173 <join+0x43>
    if(!havekids || curproc->killed){
8010418e:	85 c0                	test   %eax,%eax
80104190:	0f 84 a6 00 00 00    	je     8010423c <join+0x10c>
80104196:	8b 46 28             	mov    0x28(%esi),%eax
80104199:	85 c0                	test   %eax,%eax
8010419b:	0f 85 9b 00 00 00    	jne    8010423c <join+0x10c>
  pushcli();
...
801041b8:	0f 84 95 00 00 00    	je     80104253 <join+0x123>
  p->chan = chan;
801041be:	89 73 24             	mov    %esi,0x24(%ebx)
  p->state = SLEEPING;
801041c1:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
801041c8:	e8 33 fc ff ff       	call   80103e00 <sched>
  p->chan = 0;
801041cd:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
}
801041d4:	eb 84                	jmp    8010415a <join+0x2a>
801041d6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801041dd:	8d 76 00             	lea    0x0(%esi),%esi
        *stack = p->usrstack;
801041e0:	8b 53 0c             	mov    0xc(%ebx),%edx
801041e3:	8b 45 08             	mov    0x8(%ebp),%eax
        kfree(p->kstack);
801041e6:	83 ec 0c             	sub    $0xc,%esp
        pid = p->pid;
801041e9:	8b 73 14             	mov    0x14(%ebx),%esi
        *stack = p->usrstack;
801041ec:	89 10                	mov    %edx,(%eax)
        kfree(p->kstack);
801041ee:	ff 73 08             	push   0x8(%ebx)
801041f1:	e8 ca e2 ff ff       	call   801024c0 <kfree>
        p->kstack = 0;
801041f6:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        p->pid = 0;
801041fd:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->parent = 0;
80104204:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
8010420b:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
8010420f:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->usrstack = 0;
80104216:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        p->state = UNUSED;
8010421d:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        release(&ptable.lock);
80104224:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
8010422b:	e8 80 05 00 00       	call   801047b0 <release>
        return pid;
80104230:	83 c4 10             	add    $0x10,%esp
}
80104233:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104236:	89 f0                	mov    %esi,%eax
80104238:	5b                   	pop    %ebx
80104239:	5e                   	pop    %esi
8010423a:	5d                   	pop    %ebp
8010423b:	c3                   	ret    
...
8010423c:	83 ec 0c             	sub    $0xc,%esp
      return -1;
8010423f:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104244:	68 20 1d 11 80       	push   $0x80111d20
80104249:	e8 62 05 00 00       	call   801047b0 <release>
      return -1;
8010424e:	83 c4 10             	add    $0x10,%esp
80104251:	eb e0                	jmp    80104233 <join+0x103>
    panic("sleep");
80104253:	83 ec 0c             	sub    $0xc,%esp
80104256:	68 34 7a 10 80       	push   $0x80107a34
...
80104286:	c7 43 10 03 00 00 00 	movl   $0x3,0x10(%ebx)
  sched();
...
801042f8:	e8 b3 04 00 00       	call   801047b0 <release>
  p->chan = chan;
801042fd:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
80104300:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
80104307:	e8 f4 fa ff ff       	call   80103e00 <sched>
  p->chan = 0;
8010430c:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
...
80104331:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  p->chan = chan;
80104338:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
8010433b:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%ebx)
  sched();
...
80104359:	68 3a 7a 10 80       	push   $0x80107a3a
8010435e:	e8 1d c0 ff ff       	call   80100380 <panic>
    panic("sleep");
80104363:	83 ec 0c             	sub    $0xc,%esp
80104366:	68 34 7a 10 80       	push   $0x80107a34
...
80104398:	74 1c                	je     801043b6 <wakeup+0x46>
    if(p->state == SLEEPING && p->chan == chan)
8010439a:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
8010439e:	75 f0                	jne    80104390 <wakeup+0x20>
801043a0:	3b 58 24             	cmp    0x24(%eax),%ebx
801043a3:	75 eb                	jne    80104390 <wakeup+0x20>
      p->state = RUNNABLE;
801043a5:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
...
801043f8:	74 36                	je     80104430 <kill+0x60>
    if(p->pid == pid){
801043fa:	39 58 14             	cmp    %ebx,0x14(%eax)
801043fd:	75 f1                	jne    801043f0 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
801043ff:	83 78 10 02          	cmpl   $0x2,0x10(%eax)
      p->killed = 1;
80104403:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
8010440a:	75 07                	jne    80104413 <kill+0x43>
        p->state = RUNNABLE;
8010440c:	c7 40 10 03 00 00 00 	movl   $0x3,0x10(%eax)
      release(&ptable.lock);
...
80104459:	bb c4 1d 11 80       	mov    $0x80111dc4,%ebx
...
8010448c:	74 ea                	je     80104478 <procdump+0x28>
      state = "???";
8010448e:	ba 4b 7a 10 80       	mov    $0x80107a4b,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104493:	83 f8 05             	cmp    $0x5,%eax
80104496:	77 11                	ja     801044a9 <procdump+0x59>
80104498:	8b 14 85 ac 7a 10 80 	mov    -0x7fef8554(,%eax,4),%edx
      state = "???";
8010449f:	b8 4b 7a 10 80       	mov    $0x80107a4b,%eax
...
801044ae:	68 4f 7a 10 80       	push   $0x80107a4f
...
801044ed:	68 a1 74 10 80       	push   $0x801074a1
...
8010451a:	68 c4 7a 10 80       	push   $0x80107ac4
...
80104630:	39 58 14             	cmp    %ebx,0x14(%eax)
...
80104755:	68 cf 7a 10 80       	push   $0x80107acf
8010475a:	e8 21 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010475f:	83 ec 0c             	sub    $0xc,%esp
80104762:	68 e6 7a 10 80       	push   $0x80107ae6
...
801047cb:	68 ed 7a 10 80       	push   $0x80107aed
...
801048c0:	68 f5 7a 10 80       	push   $0x80107af5
...
80104cfb:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104d10:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104d11:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104d14:	50                   	push   %eax
80104d15:	ff 73 14             	push   0x14(%ebx)
80104d18:	68 fd 7a 10 80       	push   $0x80107afd
80104d1d:	e8 7e b9 ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
80104d22:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104e74:	68 9c 7b 10 80       	push   $0x80107b9c
...
80104e8c:	68 9b 7b 10 80       	push   $0x80107b9b
...
80104ea1:	68 8f 7b 10 80       	push   $0x80107b8f
...
80104ebf:	68 9e 7b 10 80       	push   $0x80107b9e
80104ec4:	e8 b7 b4 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104ec9:	83 ec 0c             	sub    $0xc,%esp
80104ecc:	68 80 7b 10 80       	push   $0x80107b80
...
80104f08:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
80104f40:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80104f43:	89 74 98 2c          	mov    %esi,0x2c(%eax,%ebx,4)
  filedup(f);
...
8010508b:	8b 74 98 0c          	mov    0xc(%eax,%ebx,4),%esi
...
80105098:	83 ec 0c             	sub    $0xc,%esp
  myproc()->ofile[fd] = 0;
8010509b:	c7 44 98 0c 00 00 00 	movl   $0x0,0xc(%eax,%ebx,4)
801050a2:	00 
  fileclose(f);
...
801050e8:	8b 74 90 2c          	mov    0x2c(%eax,%edx,4),%esi
...
801052cd:	58                   	pop    %eax
801052ce:	5a                   	pop    %edx
801052cf:	68 9c 7b 10 80       	push   $0x80107b9c
...
801052e8:	68 9b 7b 10 80       	push   $0x80107b9b
...
8010586e:	66 90                	xchg   %ax,%ax
    if(curproc->ofile[fd] == 0){
80105870:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
801058a3:	89 7c b0 0c          	mov    %edi,0xc(%eax,%esi,4)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
...
801058b1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
801058b8:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
801058de:	66 90                	xchg   %ax,%ax
      curproc->ofile[fd] = f;
801058e0:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
  }
  fd[0] = fd0;
...
{
  return wait();
80105920:	e9 cb e6 ff ff       	jmp    80103ff0 <wait>
...
8010597b:	8b 40 14             	mov    0x14(%eax),%eax
}
8010597e:	c9                   	leave  
8010597f:	c3                   	ret    
...
80105a36:	8b 40 28             	mov    0x28(%eax),%eax
...
80105abe:	e8 6d e1 ff ff       	call   80103c30 <clone>
}
80105ac3:	c9                   	leave  
80105ac4:	c3                   	ret    
...
80105ade:	e8 fd f0 ff ff       	call   80104be0 <argptr>
80105ae3:	83 c4 10             	add    $0x10,%esp
80105ae6:	85 c0                	test   %eax,%eax
80105ae8:	78 16                	js     80105b00 <sys_join+0x30>
    return -1;
  }
...
80105af0:	e8 3b e6 ff ff       	call   80104130 <join>
...
80105b47:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
80105b4e:	08 00 00 8e 
80105b52:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105b59:	80 
80105b5a:	c1 ea 10             	shr    $0x10,%edx
80105b5d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105b64:	80 
  for(i = 0; i < 256; i++)
...
80105b77:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
80105b7e:	00 00 ef 
  initlock(&tickslock, "time");
80105b81:	68 e1 7b 10 80       	push   $0x80107be1
80105b86:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b8b:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105b91:	c1 e8 10             	shr    $0x10,%eax
80105b94:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
80105b9a:	e8 a1 ea ff ff       	call   80104640 <initlock>
}
...
80105bbb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105bbf:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
80105c04:	ff 24 85 88 7c 10 80 	jmp    *-0x7fef8378(,%eax,4)
...
80105c23:	e8 48 dd ff ff       	call   80103970 <myproc>
80105c28:	8b 50 28             	mov    0x28(%eax),%edx
...
80105c4e:	83 78 10 04          	cmpl   $0x4,0x10(%eax)
...
80105ce5:	68 44 7c 10 80       	push   $0x80107c44
80105cea:	e8 b1 a9 ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105cef:	83 c4 20             	add    $0x20,%esp
80105cf2:	e8 79 dc ff ff       	call   80103970 <myproc>
...
80105d14:	0f 85 3e ff ff ff    	jne    80105c58 <trap+0x78>
    yield();
80105d1a:	e8 41 e5 ff ff       	call   80104260 <yield>
...
80105d2f:	e8 1c dc ff ff       	call   80103950 <cpuid>
80105d34:	57                   	push   %edi
80105d35:	56                   	push   %esi
80105d36:	50                   	push   %eax
80105d37:	68 ec 7b 10 80       	push   $0x80107bec
...
80105d65:	8b 70 28             	mov    0x28(%eax),%esi
...
80105d75:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105d78:	e8 53 ef ff ff       	call   80104cd0 <syscall>
    if(myproc()->killed)
80105d7d:	e8 ee db ff ff       	call   80103970 <myproc>
80105d82:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105d93:	5d                   	pop    %ebp
      exit();
80105d94:	e9 27 e1 ff ff       	jmp    80103ec0 <exit>
...
80105dc5:	e8 46 cb ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105dca:	e8 a1 db ff ff       	call   80103970 <myproc>
...
80105ddc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105de0:	e8 6b db ff ff       	call   80103950 <cpuid>
80105de5:	85 c0                	test   %eax,%eax
80105de7:	0f 85 28 fe ff ff    	jne    80105c15 <trap+0x35>
      acquire(&tickslock);
80105ded:	83 ec 0c             	sub    $0xc,%esp
80105df0:	68 80 3d 11 80       	push   $0x80113d80
80105df5:	e8 16 ea ff ff       	call   80104810 <acquire>
      wakeup(&ticks);
80105dfa:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
      ticks++;
80105e01:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105e08:	e8 63 e5 ff ff       	call   80104370 <wakeup>
      release(&tickslock);
80105e0d:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105e14:	e8 97 e9 ff ff       	call   801047b0 <release>
...
80105ef7:	74 78                	je     80105f71 <uartinit+0xd1>
  uart = 1;
80105ef9:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105f00:	00 00 00 
...
80105f0c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105f0f:	bf 08 7d 10 80       	mov    $0x80107d08,%edi
...
80106c13:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106c16:	e8 35 cd ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106ca0:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106ce6:	e8 05 cc ff ff       	call   801038f0 <mycpu>
...
80106cf8:	e8 f3 cb ff ff       	call   801038f0 <mycpu>
...
80106d41:	e8 aa cb ff ff       	call   801038f0 <mycpu>
...
80106d64:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106d67:	e8 84 cb ff ff       	call   801038f0 <mycpu>
...
80106e2b:	68 55 7d 10 80       	push   $0x80107d55
...
80106e90:	68 6f 7d 10 80       	push   $0x80107d6f
...
80106f18:	68 10 7e 10 80       	push   $0x80107e10
...
80106fb9:	68 8d 7d 10 80       	push   $0x80107d8d
...
8010701b:	68 a5 7d 10 80       	push   $0x80107da5
...
801070fc:	68 c1 7d 10 80       	push   $0x80107dc1
...
8010719b:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
801071cc:	68 d2 7d 10 80       	push   $0x80107dd2
...
80107242:	68 dc 7d 10 80       	push   $0x80107ddc
...
80107317:	68 f6 7d 10 80       	push   $0x80107df6
