...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 98 03 00 00       	call   3d2 <mkdir>
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 329:	ff 75 08             	push   0x8(%ebp)
  original_stack = *(uint*)(stack);
 32c:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
  return clone(start_routine, arg1, arg2, stack);
...
free(void *ap)
{
 ...
 671:	a1 ec 0b 00 00       	mov    0xbec,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 ec 0b 00 00    	mov    %edx,0xbec
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 ec 0b 00 00    	mov    %edx,0xbec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d ec 0b 00 00    	mov    0xbec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d ec 0b 00 00    	mov    0xbec,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 ec 0b 00 00    	mov    0xbec,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 ec 0b 00 00    	mov    %edx,0xbec
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 ec 0b 00 00 f0 	movl   $0xbf0,0xbec
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf f0 0b 00 00       	mov    $0xbf0,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 f0 0b 00 00 f0 	movl   $0xbf0,0xbf0
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 f4 0b 00 00 00 	movl   $0x0,0xbf4
 7e2:	00 00 00 
    if(p->s.size >= nunits){
