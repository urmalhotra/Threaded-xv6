...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 f0 02 00 00       	call   35a <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 c5 01 00 00       	call   372 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 88 01 00 00       	call   39a <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 8b 01 00 00       	call   3b2 <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 51 01 00 00       	call   382 <close>
  return r;
...
xchg(volatile uint *addr, uint newval)
{
 ...
 2e8:	74 f6                	je     2e0 <lock_acquire+0x10>
    ; // spin
}
 2ea:	5d                   	pop    %ebp
 2eb:	c3                   	ret    
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 30b:	e8 e0 03 00 00       	call   6f0 <malloc>
  original_stack = *(uint*)(stack);
 310:	8b 10                	mov    (%eax),%edx
 ...
 319:	ff 75 08             	push   0x8(%ebp)
  original_stack = *(uint*)(stack);
 31c:	89 15 a8 0b 00 00    	mov    %edx,0xba8
  return clone(start_routine, arg1, arg2, stack);
 322:	e8 db 00 00 00       	call   402 <clone>
}
 327:	c9                   	leave  
 328:	c3                   	ret    
...
int thread_join(void){
 337:	83 ec 20             	sub    $0x20,%esp
  wait_pid = join(&stack);
 33a:	50                   	push   %eax
 33b:	e8 ba 00 00 00       	call   3fa <join>
 340:	89 c3                	mov    %eax,%ebx
  free(stack);
 342:	58                   	pop    %eax
 343:	ff 75 f4             	push   -0xc(%ebp)
 346:	e8 15 03 00 00       	call   660 <free>
  return wait_pid;
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 e5 fe ff ff       	call   37a <write>
  while(--i >= 0)
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 6e fe ff ff       	call   37a <write>
 ...
 55e:	e8 17 fe ff ff       	call   37a <write>
        putc(fd, c);
 ...
 5db:	57                   	push   %edi
 5dc:	56                   	push   %esi
 5dd:	e8 98 fd ff ff       	call   37a <write>
        while(*s != 0){
 ...
 61c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 61f:	e8 56 fd ff ff       	call   37a <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 753:	e8 8a fc ff ff       	call   3e2 <sbrk>
  if(p == (char*)-1)
