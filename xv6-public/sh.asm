...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 ca 0e 00 00       	call   efa <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 5d 0e 00 00       	call   eb2 <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 5b 0e 00 00       	call   ec2 <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 27 0e 00 00       	call   ee2 <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 35 0e 00 00       	call   f2a <chdir>
  ...
  exit();
     11a:	e8 9b 0d 00 00       	call   eba <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 30 0d 00 00       	call   eba <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 17 0d 00 00       	call   eb2 <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 0f 0d 00 00       	call   ef2 <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 b5 0c 00 00       	call   eba <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 ab 0c 00 00       	call   eca <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 93 0c 00 00       	call   ee2 <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 8a 0c 00 00       	call   ee2 <close>
    wait();
     258:	e8 65 0c 00 00       	call   ec2 <wait>
    wait();
     25d:	e8 60 0c 00 00       	call   ec2 <wait>
    break;
    ...
    wait();
     270:	e8 4d 0c 00 00       	call   ec2 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 57 0c 00 00       	call   ee2 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 62 0c 00 00       	call   efa <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 59 0d 00 00       	call   1020 <printf>
      exit();
     2c7:	e8 ee 0b 00 00       	call   eba <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 ff 0b 00 00       	call   ee2 <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 46 0c 00 00       	call   f32 <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 ed 0b 00 00       	call   ee2 <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 e4 0b 00 00       	call   ee2 <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 d1 0b 00 00       	call   ee2 <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 18 0c 00 00       	call   f32 <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 bf 0b 00 00       	call   ee2 <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 b6 0b 00 00       	call   ee2 <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 c5 01 00 00       	call   ed2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 88 01 00 00       	call   efa <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 8b 01 00 00       	call   f12 <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 51 01 00 00       	call   ee2 <close>
  return r;
...
lock_release(lock_t *spinlock)
{
     ...
     e55:	8b 55 08             	mov    0x8(%ebp),%edx
     e58:	f0 87 02             	lock xchg %eax,(%edx)
...
00000e60 <thread_create>:

int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
     e60:	55                   	push   %ebp
     e61:	89 e5                	mov    %esp,%ebp
     e63:	83 ec 14             	sub    $0x14,%esp
  void* stack = malloc(2*4096);
     e66:	68 00 20 00 00       	push   $0x2000
     e6b:	e8 e0 03 00 00       	call   1250 <malloc>
  ...
  original_stack = *(uint*)(stack);
     e7c:	89 15 84 1b 00 00    	mov    %edx,0x1b84
  return clone(start_routine, arg1, arg2, stack);
     e82:	e8 db 00 00 00       	call   f62 <clone>
}
     e87:	c9                   	leave  
     e88:	c3                   	ret    
...
int thread_join(void){
  ...
  wait_pid = join(&stack);
     e9a:	50                   	push   %eax
     e9b:	e8 ba 00 00 00       	call   f5a <join>
     ea0:	89 c3                	mov    %eax,%ebx
  free(stack);
     ea2:	58                   	pop    %eax
     ea3:	ff 75 f4             	push   -0xc(%ebp)
     ea6:	e8 15 03 00 00       	call   11c0 <free>
  return wait_pid;
...
SYSCALL(fork)
     eb2:	b8 01 00 00 00       	mov    $0x1,%eax
     eb7:	cd 40                	int    $0x40
     eb9:	c3                   	ret    

00000eba <exit>:
SYSCALL(exit)
     eba:	b8 02 00 00 00       	mov    $0x2,%eax
     ebf:	cd 40                	int    $0x40
     ec1:	c3                   	ret    

00000ec2 <wait>:
SYSCALL(wait)
     ec2:	b8 03 00 00 00       	mov    $0x3,%eax
     ec7:	cd 40                	int    $0x40
     ec9:	c3                   	ret    

00000eca <pipe>:
SYSCALL(pipe)
     eca:	b8 04 00 00 00       	mov    $0x4,%eax
     ecf:	cd 40                	int    $0x40
     ed1:	c3                   	ret    

00000ed2 <read>:
SYSCALL(read)
     ed2:	b8 05 00 00 00       	mov    $0x5,%eax
     ed7:	cd 40                	int    $0x40
     ed9:	c3                   	ret    

00000eda <write>:
SYSCALL(write)
     eda:	b8 10 00 00 00       	mov    $0x10,%eax
     edf:	cd 40                	int    $0x40
     ee1:	c3                   	ret    

00000ee2 <close>:
SYSCALL(close)
     ee2:	b8 15 00 00 00       	mov    $0x15,%eax
     ee7:	cd 40                	int    $0x40
     ee9:	c3                   	ret    

00000eea <kill>:
SYSCALL(kill)
     eea:	b8 06 00 00 00       	mov    $0x6,%eax
     eef:	cd 40                	int    $0x40
     ef1:	c3                   	ret    

00000ef2 <exec>:
SYSCALL(exec)
     ef2:	b8 07 00 00 00       	mov    $0x7,%eax
     ef7:	cd 40                	int    $0x40
     ef9:	c3                   	ret    

00000efa <open>:
SYSCALL(open)
     efa:	b8 0f 00 00 00       	mov    $0xf,%eax
     eff:	cd 40                	int    $0x40
     f01:	c3                   	ret    

00000f02 <mknod>:
SYSCALL(mknod)
     f02:	b8 11 00 00 00       	mov    $0x11,%eax
     f07:	cd 40                	int    $0x40
     f09:	c3                   	ret    

00000f0a <unlink>:
SYSCALL(unlink)
     f0a:	b8 12 00 00 00       	mov    $0x12,%eax
     f0f:	cd 40                	int    $0x40
     f11:	c3                   	ret    

00000f12 <fstat>:
SYSCALL(fstat)
     f12:	b8 08 00 00 00       	mov    $0x8,%eax
     f17:	cd 40                	int    $0x40
     f19:	c3                   	ret    

00000f1a <link>:
SYSCALL(link)
     f1a:	b8 13 00 00 00       	mov    $0x13,%eax
     f1f:	cd 40                	int    $0x40
     f21:	c3                   	ret    

00000f22 <mkdir>:
SYSCALL(mkdir)
     f22:	b8 14 00 00 00       	mov    $0x14,%eax
     f27:	cd 40                	int    $0x40
     f29:	c3                   	ret    

00000f2a <chdir>:
SYSCALL(chdir)
     f2a:	b8 09 00 00 00       	mov    $0x9,%eax
     f2f:	cd 40                	int    $0x40
     f31:	c3                   	ret    

00000f32 <dup>:
SYSCALL(dup)
     f32:	b8 0a 00 00 00       	mov    $0xa,%eax
     f37:	cd 40                	int    $0x40
     f39:	c3                   	ret    

00000f3a <getpid>:
SYSCALL(getpid)
     f3a:	b8 0b 00 00 00       	mov    $0xb,%eax
     f3f:	cd 40                	int    $0x40
     f41:	c3                   	ret    

00000f42 <sbrk>:
SYSCALL(sbrk)
     f42:	b8 0c 00 00 00       	mov    $0xc,%eax
     f47:	cd 40                	int    $0x40
     f49:	c3                   	ret    

00000f4a <sleep>:
SYSCALL(sleep)
     f4a:	b8 0d 00 00 00       	mov    $0xd,%eax
     f4f:	cd 40                	int    $0x40
     f51:	c3                   	ret    

00000f52 <uptime>:
SYSCALL(uptime)
     f52:	b8 0e 00 00 00       	mov    $0xe,%eax
     f57:	cd 40                	int    $0x40
     f59:	c3                   	ret    

00000f5a <join>:
SYSCALL(join)
     f5a:	b8 17 00 00 00       	mov    $0x17,%eax
     f5f:	cd 40                	int    $0x40
     f61:	c3                   	ret    

00000f62 <clone>:
SYSCALL(clone)
     f62:	b8 16 00 00 00       	mov    $0x16,%eax
     f67:	cd 40                	int    $0x40
     f69:	c3                   	ret    
     ...
     f7c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     fee:	56                   	push   %esi
     fef:	57                   	push   %edi
     ff0:	e8 e5 fe ff ff       	call   eda <write>
  while(--i >= 0)
    ...
    1029:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1065:	57                   	push   %edi
    1066:	56                   	push   %esi
    1067:	e8 6e fe ff ff       	call   eda <write>
  ...
  write(fd, &c, 1);
    ...
    10be:	e8 17 fe ff ff       	call   eda <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10cf:	57                   	push   %edi
    10d0:	56                   	push   %esi
    10d1:	e8 04 fe ff ff       	call   eda <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    113b:	57                   	push   %edi
    113c:	56                   	push   %esi
    113d:	e8 98 fd ff ff       	call   eda <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    117f:	e8 56 fd ff ff       	call   eda <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11c1:	a1 88 1b 00 00       	mov    0x1b88,%eax
{
  ...
  freep = p;
    ...
    1201:	5b                   	pop    %ebx
  freep = p;
    1202:	89 15 88 1b 00 00    	mov    %edx,0x1b88
}
    1208:	5e                   	pop    %esi
    1209:	5f                   	pop    %edi
    120a:	5d                   	pop    %ebp
  ...
  freep = p;
    123c:	89 15 88 1b 00 00    	mov    %edx,0x1b88
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    125c:	8b 3d 88 1b 00 00    	mov    0x1b88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    12a1:	8b 3d 88 1b 00 00    	mov    0x1b88,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12b3:	e8 8a fc ff ff       	call   f42 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    12cf:	8b 15 88 1b 00 00    	mov    0x1b88,%edx
    ...
    12fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    12ff:	89 15 88 1b 00 00    	mov    %edx,0x1b88
}
    ...
    130f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1310:	c7 05 88 1b 00 00 8c 	movl   $0x1b8c,0x1b88
    1317:	1b 00 00 
    base.s.size = 0;
    131a:	bf 8c 1b 00 00       	mov    $0x1b8c,%edi
    base.s.ptr = freep = prevp = &base;
    131f:	c7 05 8c 1b 00 00 8c 	movl   $0x1b8c,0x1b8c
    1326:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1329:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    132b:	c7 05 90 1b 00 00 00 	movl   $0x0,0x1b90
    1332:	00 00 00 
    if(p->s.size >= nunits){
