  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  5b:	83 c4 10             	add    $0x10,%esp
    if(fork() > 0)
  5e:	e8 bf 03 00 00       	call   422 <fork>
  ...
  a2:	50                   	push   %eax
  a3:	e8 c2 03 00 00       	call   46a <open>
...
//    printf(fd, "%d\n", i);
  ...
  b8:	56                   	push   %esi
  b9:	57                   	push   %edi
  ba:	e8 8b 03 00 00       	call   44a <write>
  for(i = 0; i < 20; i++)
  ...
  ed:	50                   	push   %eax
  ee:	e8 77 03 00 00       	call   46a <open>
 ...
 108:	56                   	push   %esi
 109:	57                   	push   %edi
 10a:	e8 33 03 00 00       	call   442 <read>
  for (i = 0; i < 20; i++)
 ...
 11b:	e8 32 03 00 00       	call   452 <close>
  ...
  wait();
 120:	e8 0d 03 00 00       	call   432 <wait>

  exit();
 125:	e8 00 03 00 00       	call   42a <exit>
  path[8] += i;
 ...
 269:	31 db                	xor    %ebx,%ebx
{
 ...
 275:	57                   	push   %edi
 276:	6a 00                	push   $0x0
 278:	e8 c5 01 00 00       	call   442 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2dd:	e8 88 01 00 00       	call   46a <open>
  if(fd < 0)
 ...
 2f1:	50                   	push   %eax
 2f2:	e8 8b 01 00 00       	call   482 <fstat>
  close(fd);
...
xchg(volatile uint *addr, uint newval)
{
 ...
 3b8:	74 f6                	je     3b0 <lock_acquire+0x10>
    ; // spin
}
 3ba:	5d                   	pop    %ebp
 3bb:	c3                   	ret    
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 3db:	e8 e0 03 00 00       	call   7c0 <malloc>
 ...
 3e9:	ff 75 08             	push   0x8(%ebp)
  original_stack = *(uint*)(stack);
 3ec:	89 15 98 0c 00 00    	mov    %edx,0xc98
  return clone(start_routine, arg1, arg2, stack);
 3f2:	e8 db 00 00 00       	call   4d2 <clone>
}
 3f7:	c9                   	leave  
 3f8:	c3                   	ret    
...
int thread_join(void){
 407:	83 ec 20             	sub    $0x20,%esp
  wait_pid = join(&stack);
 40a:	50                   	push   %eax
 40b:	e8 ba 00 00 00       	call   4ca <join>
 410:	89 c3                	mov    %eax,%ebx
  free(stack);
 412:	58                   	pop    %eax
 413:	ff 75 f4             	push   -0xc(%ebp)
 416:	e8 15 03 00 00       	call   730 <free>
  return wait_pid;
 ...
 4ec:	89 d1                	mov    %edx,%ecx
{
 ...
 55e:	56                   	push   %esi
 55f:	57                   	push   %edi
 560:	e8 e5 fe ff ff       	call   44a <write>
  while(--i >= 0)
 ...
 599:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5d5:	57                   	push   %edi
 5d6:	56                   	push   %esi
 5d7:	e8 6e fe ff ff       	call   44a <write>
 ...
 62e:	e8 17 fe ff ff       	call   44a <write>
        putc(fd, c);
 ...
 63f:	57                   	push   %edi
 640:	56                   	push   %esi
 641:	e8 04 fe ff ff       	call   44a <write>
        putc(fd, c);
 ...
 6ab:	57                   	push   %edi
 6ac:	56                   	push   %esi
 6ad:	e8 98 fd ff ff       	call   44a <write>
        while(*s != 0){
 ...
 6ec:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6ef:	e8 56 fd ff ff       	call   44a <write>
        ap++;
...
free(void *ap)
{
 ...
 731:	a1 9c 0c 00 00       	mov    0xc9c,%eax
{
 ...
 771:	5b                   	pop    %ebx
  freep = p;
 772:	89 15 9c 0c 00 00    	mov    %edx,0xc9c
}
 778:	5e                   	pop    %esi
 779:	5f                   	pop    %edi
 77a:	5d                   	pop    %ebp
 ...
 7a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7ac:	89 15 9c 0c 00 00    	mov    %edx,0xc9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7cc:	8b 3d 9c 0c 00 00    	mov    0xc9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 80f:	73 4f                	jae    860 <malloc+0xa0>
    ...
    if(p == freep)
 811:	8b 3d 9c 0c 00 00    	mov    0xc9c,%edi
 ...
 823:	e8 8a fc ff ff       	call   4b2 <sbrk>
  if(p == (char*)-1)
 ...
 83a:	e8 f1 fe ff ff       	call   730 <free>
  return freep;
 83f:	8b 15 9c 0c 00 00    	mov    0xc9c,%edx
 ...
 86c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 86f:	89 15 9c 0c 00 00    	mov    %edx,0xc9c
}
 ...
 87f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 880:	c7 05 9c 0c 00 00 a0 	movl   $0xca0,0xc9c
 887:	0c 00 00 
    base.s.size = 0;
 88a:	bf a0 0c 00 00       	mov    $0xca0,%edi
    base.s.ptr = freep = prevp = &base;
 88f:	c7 05 a0 0c 00 00 a0 	movl   $0xca0,0xca0
 896:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 899:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 89b:	c7 05 a4 0c 00 00 00 	movl   $0x0,0xca4
 8a2:	00 00 00 
    if(p->s.size >= nunits){
