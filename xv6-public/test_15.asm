...
main(int argc, char *argv[])
{
   ...
   e:	51                   	push   %ecx
   ppid = getpid();
   f:	e8 d6 04 00 00       	call   4ea <getpid>

   lock_init(&lock);
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	68 48 0d 00 00       	push   $0xd48
   ppid = getpid();
  1c:	a3 50 0d 00 00       	mov    %eax,0xd50
   lock_init(&lock);
  21:	e8 aa 03 00 00       	call   3d0 <lock_init>

   int i;
   for (i = 0; i < num_threads; i++) {
  26:	a1 44 0d 00 00       	mov    0xd44,%eax
  ...
  40:	a1 44 0d 00 00       	mov    0xd44,%eax
  ...
  99:	5b                   	pop    %ebx
  9a:	ff 35 50 0d 00 00    	push   0xd50
  a0:	e8 f5 03 00 00       	call   49a <kill>
  a5:	e8 c0 03 00 00       	call   46a <exit>
   for (i = 0; i < num_threads; i++) {
  ...
  b8:	a1 44 0d 00 00       	mov    0xd44,%eax
  ...
  ea:	0f af 05 40 0d 00 00 	imul   0xd40,%eax
  f1:	3b 05 4c 0d 00 00    	cmp    0xd4c,%eax
 ...
 122:	e8 a9 04 00 00       	call   5d0 <printf>
   exit();
 127:	e8 3e 03 00 00       	call   46a <exit>
...
worker(void *arg1, void *arg2) {
 ...
 134:	83 ec 04             	sub    $0x4,%esp
   int i, j, tmp;
   for (i = 0; i < loops; i++) {
 137:	a1 40 0d 00 00       	mov    0xd40,%eax
 ...
 14b:	83 c3 01             	add    $0x1,%ebx
      lock_acquire(&lock);
 14e:	68 48 0d 00 00       	push   $0xd48
 153:	e8 88 02 00 00       	call   3e0 <lock_acquire>
      tmp = global;
      for(j = 0; j < 50; j++); // take some time
      global = tmp + 1;
      lock_release(&lock);
 158:	c7 04 24 48 0d 00 00 	movl   $0xd48,(%esp)
      global = tmp + 1;
 15f:	83 05 4c 0d 00 00 01 	addl   $0x1,0xd4c
      lock_release(&lock);
 166:	e8 95 02 00 00       	call   400 <lock_release>
   for (i = 0; i < loops; i++) {
 16b:	83 c4 10             	add    $0x10,%esp
 16e:	39 1d 40 0d 00 00    	cmp    %ebx,0xd40
 174:	7f d2                	jg     148 <worker+0x18>
   }
   exit();
 176:	e8 ef 02 00 00       	call   46a <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 c5 01 00 00       	call   482 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 88 01 00 00       	call   4aa <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 8b 01 00 00       	call   4c2 <fstat>
  close(fd);
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 41b:	e8 e0 03 00 00       	call   800 <malloc>
 ...
 429:	ff 75 08             	push   0x8(%ebp)
  original_stack = *(uint*)(stack);
 42c:	89 15 54 0d 00 00    	mov    %edx,0xd54
  return clone(start_routine, arg1, arg2, stack);
 432:	e8 db 00 00 00       	call   512 <clone>
}
 437:	c9                   	leave  
 438:	c3                   	ret    
...
int thread_join(void){
 447:	83 ec 20             	sub    $0x20,%esp
  wait_pid = join(&stack);
 44a:	50                   	push   %eax
 44b:	e8 ba 00 00 00       	call   50a <join>
 450:	89 c3                	mov    %eax,%ebx
  free(stack);
 452:	58                   	pop    %eax
 453:	ff 75 f4             	push   -0xc(%ebp)
 456:	e8 15 03 00 00       	call   770 <free>
  return wait_pid;
 ...
 52c:	89 d1                	mov    %edx,%ecx
{
 ...
 59e:	56                   	push   %esi
 59f:	57                   	push   %edi
 5a0:	e8 e5 fe ff ff       	call   48a <write>
  while(--i >= 0)
 ...
 5d9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 615:	57                   	push   %edi
 616:	56                   	push   %esi
 617:	e8 6e fe ff ff       	call   48a <write>
 ...
 66e:	e8 17 fe ff ff       	call   48a <write>
        putc(fd, c);
 ...
 67f:	57                   	push   %edi
 680:	56                   	push   %esi
 681:	e8 04 fe ff ff       	call   48a <write>
        putc(fd, c);
 ...
 6eb:	57                   	push   %edi
 6ec:	56                   	push   %esi
 6ed:	e8 98 fd ff ff       	call   48a <write>
        while(*s != 0){
 ...
 72c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 72f:	e8 56 fd ff ff       	call   48a <write>
        ap++;
...
free(void *ap)
{
 ...
 771:	a1 58 0d 00 00       	mov    0xd58,%eax
{
 ...
 7b1:	5b                   	pop    %ebx
  freep = p;
 7b2:	89 15 58 0d 00 00    	mov    %edx,0xd58
}
 7b8:	5e                   	pop    %esi
 7b9:	5f                   	pop    %edi
 7ba:	5d                   	pop    %ebp
 ...
 7e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7ec:	89 15 58 0d 00 00    	mov    %edx,0xd58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 809:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 80c:	8b 3d 58 0d 00 00    	mov    0xd58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 84f:	73 4f                	jae    8a0 <malloc+0xa0>
    ...
    if(p == freep)
 851:	8b 3d 58 0d 00 00    	mov    0xd58,%edi
 ...
 863:	e8 8a fc ff ff       	call   4f2 <sbrk>
  if(p == (char*)-1)
 ...
 87a:	e8 f1 fe ff ff       	call   770 <free>
  return freep;
 87f:	8b 15 58 0d 00 00    	mov    0xd58,%edx
 ...
 8ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8af:	89 15 58 0d 00 00    	mov    %edx,0xd58
}
 ...
 8bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8c0:	c7 05 58 0d 00 00 5c 	movl   $0xd5c,0xd58
 8c7:	0d 00 00 
    base.s.size = 0;
 8ca:	bf 5c 0d 00 00       	mov    $0xd5c,%edi
    base.s.ptr = freep = prevp = &base;
 8cf:	c7 05 5c 0d 00 00 5c 	movl   $0xd5c,0xd5c
 8d6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8db:	c7 05 60 0d 00 00 00 	movl   $0x0,0xd60
 8e2:	00 00 00 
    if(p->s.size >= nunits){
