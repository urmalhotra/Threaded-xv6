...
main(int argc, char *argv[])
{
  ...
  11:	83 ec 18             	sub    $0x18,%esp
   ppid = getpid();
  14:	e8 e1 05 00 00       	call   5fa <getpid>

   void *stack, *p = malloc(PGSIZE * 2);
  19:	83 ec 0c             	sub    $0xc,%esp
  1c:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  21:	a3 94 0e 00 00       	mov    %eax,0xe94
   void *stack, *p = malloc(PGSIZE * 2);
  26:	e8 e5 08 00 00       	call   910 <malloc>
   assert(p != NULL);
  2b:	83 c4 10             	add    $0x10,%esp
  2e:	85 c0                	test   %eax,%eax
  30:	0f 84 da 00 00 00    	je     110 <main+0x110>
   printf(1,"ok1");
  36:	83 ec 08             	sub    $0x8,%esp
  39:	89 c3                	mov    %eax,%ebx
  3b:	68 67 0a 00 00       	push   $0xa67
  ...
  4e:	25 ff 0f 00 00       	and    $0xfff,%eax
  53:	74 0a                	je     5f <main+0x5f>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  55:	89 da                	mov    %ebx,%edx
  57:	29 c2                	sub    %eax,%edx
  59:	8d ba 00 10 00 00    	lea    0x1000(%edx),%edi
   else
     stack = p;

   int arg1 = 42, arg2 = 24;
   int clone_pid = clone(worker, &arg1, &arg2, stack);
  5f:	8d 45 e0             	lea    -0x20(%ebp),%eax
  62:	57                   	push   %edi
  63:	50                   	push   %eax
  64:	8d 45 dc             	lea    -0x24(%ebp),%eax
  67:	50                   	push   %eax
  68:	68 d0 01 00 00       	push   $0x1d0
   int arg1 = 42, arg2 = 24;
  6d:	c7 45 dc 2a 00 00 00 	movl   $0x2a,-0x24(%ebp)
  74:	c7 45 e0 18 00 00 00 	movl   $0x18,-0x20(%ebp)
   int clone_pid = clone(worker, &arg1, &arg2, stack);
  7b:	e8 a2 05 00 00       	call   622 <clone>
   assert(clone_pid > 0);
  ...
  87:	7e 6a                	jle    f3 <main+0xf3>
   printf(1,"ok1");
  89:	50                   	push   %eax
  8a:	50                   	push   %eax
  8b:	68 67 0a 00 00       	push   $0xa67
  90:	6a 01                	push   $0x1
  92:	e8 49 06 00 00       	call   6e0 <printf>

   void *join_stack;
   int join_pid = join(&join_stack);
  97:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  9a:	89 04 24             	mov    %eax,(%esp)
  9d:	e8 78 05 00 00       	call   61a <join>
   assert(join_pid == clone_pid);
  a2:	83 c4 10             	add    $0x10,%esp
  a5:	39 c6                	cmp    %eax,%esi
  a7:	0f 84 80 00 00 00    	je     12d <main+0x12d>
  ad:	6a 2b                	push   $0x2b
  af:	68 08 0a 00 00       	push   $0xa08
  b4:	68 12 0a 00 00       	push   $0xa12
  b9:	6a 01                	push   $0x1
  bb:	e8 20 06 00 00       	call   6e0 <printf>
  c0:	83 c4 0c             	add    $0xc,%esp
  c3:	68 79 0a 00 00       	push   $0xa79
   assert(clone_pid > 0);
  c8:	68 25 0a 00 00       	push   $0xa25
  cd:	6a 01                	push   $0x1
  cf:	e8 0c 06 00 00       	call   6e0 <printf>
  d4:	58                   	pop    %eax
  d5:	5a                   	pop    %edx
  d6:	68 39 0a 00 00       	push   $0xa39
  db:	6a 01                	push   $0x1
  dd:	e8 fe 05 00 00       	call   6e0 <printf>
  e2:	59                   	pop    %ecx
  e3:	ff 35 94 0e 00 00    	push   0xe94
  e9:	e8 bc 04 00 00       	call   5aa <kill>
  ee:	e8 87 04 00 00       	call   57a <exit>
  f3:	6a 26                	push   $0x26
  f5:	68 08 0a 00 00       	push   $0xa08
  fa:	68 12 0a 00 00       	push   $0xa12
  ff:	6a 01                	push   $0x1
 101:	e8 da 05 00 00       	call   6e0 <printf>
 106:	83 c4 0c             	add    $0xc,%esp
 109:	68 6b 0a 00 00       	push   $0xa6b
 10e:	eb b8                	jmp    c8 <main+0xc8>
   assert(p != NULL);
 110:	6a 1d                	push   $0x1d
 112:	68 08 0a 00 00       	push   $0xa08
 117:	68 12 0a 00 00       	push   $0xa12
 11c:	6a 01                	push   $0x1
 11e:	e8 bd 05 00 00       	call   6e0 <printf>
 123:	83 c4 0c             	add    $0xc,%esp
 126:	68 5d 0a 00 00       	push   $0xa5d
 12b:	eb 9b                	jmp    c8 <main+0xc8>
   printf(1,"ok1");
 12d:	50                   	push   %eax
 12e:	50                   	push   %eax
 12f:	68 67 0a 00 00       	push   $0xa67
 134:	6a 01                	push   $0x1
 136:	e8 a5 05 00 00       	call   6e0 <printf>
   assert(stack == join_stack);
 13b:	83 c4 10             	add    $0x10,%esp
 13e:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
 141:	74 20                	je     163 <main+0x163>
 143:	6a 2d                	push   $0x2d
 145:	68 08 0a 00 00       	push   $0xa08
 14a:	68 12 0a 00 00       	push   $0xa12
 14f:	6a 01                	push   $0x1
 151:	e8 8a 05 00 00       	call   6e0 <printf>
 156:	83 c4 0c             	add    $0xc,%esp
 159:	68 8f 0a 00 00       	push   $0xa8f
 15e:	e9 65 ff ff ff       	jmp    c8 <main+0xc8>
   printf(1,"ok1");
 163:	56                   	push   %esi
 164:	56                   	push   %esi
 165:	68 67 0a 00 00       	push   $0xa67
 16a:	6a 01                	push   $0x1
 16c:	e8 6f 05 00 00       	call   6e0 <printf>
   assert(global == 2);
 171:	83 c4 10             	add    $0x10,%esp
 174:	83 3d 90 0e 00 00 02 	cmpl   $0x2,0xe90
 17b:	74 20                	je     19d <main+0x19d>
 17d:	6a 2f                	push   $0x2f
 ...
 193:	68 a3 0a 00 00       	push   $0xaa3
 198:	e9 2b ff ff ff       	jmp    c8 <main+0xc8>
   printf(1,"ok1");
 19d:	50                   	push   %eax
 19e:	50                   	push   %eax
 19f:	68 67 0a 00 00       	push   $0xa67
 1a4:	6a 01                	push   $0x1
 ...
 1ab:	5a                   	pop    %edx
 1ac:	59                   	pop    %ecx
 1ad:	68 af 0a 00 00       	push   $0xaaf
 1b2:	6a 01                	push   $0x1
 1b4:	e8 27 05 00 00       	call   6e0 <printf>
   free(p);
 1b9:	89 1c 24             	mov    %ebx,(%esp)
 1bc:	e8 bf 06 00 00       	call   880 <free>
   exit();
 1c1:	e8 b4 03 00 00       	call   57a <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1e6:	75 2a                	jne    212 <worker+0x42>
   assert(global == 1);
 1e8:	83 3d 90 0e 00 00 01 	cmpl   $0x1,0xe90
 1ef:	0f 84 80 00 00 00    	je     275 <worker+0xa5>
 1f5:	6a 3d                	push   $0x3d
 1f7:	68 08 0a 00 00       	push   $0xa08
 1fc:	68 12 0a 00 00       	push   $0xa12
 201:	6a 01                	push   $0x1
 203:	e8 d8 04 00 00       	call   6e0 <printf>
 208:	83 c4 0c             	add    $0xc,%esp
 20b:	68 51 0a 00 00       	push   $0xa51
 210:	eb 1b                	jmp    22d <worker+0x5d>
   assert(tmp2 == 24);
 212:	6a 3c                	push   $0x3c
 214:	68 08 0a 00 00       	push   $0xa08
 219:	68 12 0a 00 00       	push   $0xa12
 21e:	6a 01                	push   $0x1
 220:	e8 bb 04 00 00       	call   6e0 <printf>
 225:	83 c4 0c             	add    $0xc,%esp
 228:	68 46 0a 00 00       	push   $0xa46
 22d:	68 25 0a 00 00       	push   $0xa25
 232:	6a 01                	push   $0x1
 234:	e8 a7 04 00 00       	call   6e0 <printf>
 239:	58                   	pop    %eax
 23a:	5a                   	pop    %edx
 23b:	68 39 0a 00 00       	push   $0xa39
 240:	6a 01                	push   $0x1
 242:	e8 99 04 00 00       	call   6e0 <printf>
 247:	59                   	pop    %ecx
 248:	ff 35 94 0e 00 00    	push   0xe94
 24e:	e8 57 03 00 00       	call   5aa <kill>
 253:	e8 22 03 00 00       	call   57a <exit>
   assert(tmp1 == 42);
 258:	6a 3b                	push   $0x3b
 25a:	68 08 0a 00 00       	push   $0xa08
 25f:	68 12 0a 00 00       	push   $0xa12
 264:	6a 01                	push   $0x1
 266:	e8 75 04 00 00       	call   6e0 <printf>
 26b:	83 c4 0c             	add    $0xc,%esp
 26e:	68 1a 0a 00 00       	push   $0xa1a
 273:	eb b8                	jmp    22d <worker+0x5d>
   global++;
 275:	c7 05 90 0e 00 00 02 	movl   $0x2,0xe90
 27c:	00 00 00 
   exit();
 27f:	e8 f6 02 00 00       	call   57a <exit>
 ...
 3b9:	31 db                	xor    %ebx,%ebx
{
 ...
 3c5:	57                   	push   %edi
 3c6:	6a 00                	push   $0x0
 3c8:	e8 c5 01 00 00       	call   592 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 42d:	e8 88 01 00 00       	call   5ba <open>
  if(fd < 0)
 ...
 441:	50                   	push   %eax
 442:	e8 8b 01 00 00       	call   5d2 <fstat>
  close(fd);
 447:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 44a:	89 c6                	mov    %eax,%esi
  close(fd);
 44c:	e8 51 01 00 00       	call   5a2 <close>
  return r;
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 52b:	e8 e0 03 00 00       	call   910 <malloc>
 ...
 539:	ff 75 08             	push   0x8(%ebp)
  original_stack = *(uint*)(stack);
 53c:	89 15 98 0e 00 00    	mov    %edx,0xe98
  return clone(start_routine, arg1, arg2, stack);
 542:	e8 db 00 00 00       	call   622 <clone>
}
 547:	c9                   	leave  
 548:	c3                   	ret    
...
int thread_join(void){
 557:	83 ec 20             	sub    $0x20,%esp
  wait_pid = join(&stack);
 55a:	50                   	push   %eax
 55b:	e8 ba 00 00 00       	call   61a <join>
 560:	89 c3                	mov    %eax,%ebx
  free(stack);
 562:	58                   	pop    %eax
 563:	ff 75 f4             	push   -0xc(%ebp)
 566:	e8 15 03 00 00       	call   880 <free>
  return wait_pid;
 ...
 63c:	89 d1                	mov    %edx,%ecx
{
 ...
 669:	0f b6 92 1c 0b 00 00 	movzbl 0xb1c(%edx),%edx
 ...
 6ae:	56                   	push   %esi
 6af:	57                   	push   %edi
 6b0:	e8 e5 fe ff ff       	call   59a <write>
  while(--i >= 0)
 ...
 6e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 725:	57                   	push   %edi
 726:	56                   	push   %esi
 727:	e8 6e fe ff ff       	call   59a <write>
 ...
 759:	ff 24 85 c4 0a 00 00 	jmp    *0xac4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 77e:	e8 17 fe ff ff       	call   59a <write>
        putc(fd, c);
 ...
 78f:	57                   	push   %edi
 790:	56                   	push   %esi
 791:	e8 04 fe ff ff       	call   59a <write>
        putc(fd, c);
 ...
 7fb:	57                   	push   %edi
 7fc:	56                   	push   %esi
 7fd:	e8 98 fd ff ff       	call   59a <write>
        while(*s != 0){
 ...
 83c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 83f:	e8 56 fd ff ff       	call   59a <write>
        ap++;
 ...
 867:	90                   	nop
          s = "(null)";
 868:	ba bc 0a 00 00       	mov    $0xabc,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 881:	a1 9c 0e 00 00       	mov    0xe9c,%eax
{
 ...
 8c1:	5b                   	pop    %ebx
  freep = p;
 8c2:	89 15 9c 0e 00 00    	mov    %edx,0xe9c
}
 8c8:	5e                   	pop    %esi
 8c9:	5f                   	pop    %edi
 8ca:	5d                   	pop    %ebp
 ...
 8f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 8fc:	89 15 9c 0e 00 00    	mov    %edx,0xe9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 919:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 91c:	8b 3d 9c 0e 00 00    	mov    0xe9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 95f:	73 4f                	jae    9b0 <malloc+0xa0>
    ...
    if(p == freep)
 961:	8b 3d 9c 0e 00 00    	mov    0xe9c,%edi
 ...
 973:	e8 8a fc ff ff       	call   602 <sbrk>
  if(p == (char*)-1)
 ...
 98a:	e8 f1 fe ff ff       	call   880 <free>
  return freep;
 98f:	8b 15 9c 0e 00 00    	mov    0xe9c,%edx
 ...
 9bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 9bf:	89 15 9c 0e 00 00    	mov    %edx,0xe9c
}
 ...
 9cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 9d0:	c7 05 9c 0e 00 00 a0 	movl   $0xea0,0xe9c
 9d7:	0e 00 00 
    base.s.size = 0;
 9da:	bf a0 0e 00 00       	mov    $0xea0,%edi
    base.s.ptr = freep = prevp = &base;
 9df:	c7 05 a0 0e 00 00 a0 	movl   $0xea0,0xea0
 9e6:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 9e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 9eb:	c7 05 a4 0e 00 00 00 	movl   $0x0,0xea4
 9f2:	00 00 00 
    if(p->s.size >= nunits){
